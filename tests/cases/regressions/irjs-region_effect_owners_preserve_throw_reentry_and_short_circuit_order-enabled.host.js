// Harness of the source test (enabled=true, fail=false, seed=7): host calls and re-entrant reads
...
(() => {
  ...
  globalThis.enabled = function () { events.push('enabled'); return true; };
  globalThis.read = function () { events.push('read'); return 7; };
  globalThis.next = function (previous) { events.push('next:' + previous, 'reenter:' + getCalls()); if (false && previous == 1) throw Error('stop'); return previous + 1; };

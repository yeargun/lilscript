...
| M1.7 Names and docs | Modules renamed by role: `src/check`, `src/program`, `src/js`, `src/build.rs`; `compile_source` and `compile_path`. Docs describing the old route moved to [history](knowledge/history/README.md) |

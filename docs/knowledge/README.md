...
8. [Active migration](migration/README.md)
   - [00 — freeze current evidence](migration/00-freeze-current-evidence.md)
   - [01 — paired runner contract](migration/01-paired-runner-contract.md)
   - [02 — scalar language core](migration/02-scalar-language-core.md)
   - [03 — control flow, functions, effects](migration/03-control-flow-functions-effects.md)
   - [04 — aggregates, collections, objects](migration/04-aggregates-collections-objects.md)
   - [05 — modules, delivery, progressive enhancement](migration/05-modules-delivery-progressive.md)
   - [06 — browser and host boundaries](migration/06-browser-host-boundaries.md)
   - [07 — global codec search](migration/07-global-codec-search.md)
   - [08 — scale corpus and release](migration/08-scale-corpus-release.md)
   - [09 — jQuery public-library convergence](migration/09-jquery-library-convergence.md)
...
10. [Old migration plans](old-migration/README.md) — historical instructions and measurements only

...
Objectives: [compilation objectives](../history/compilation/objectives.md).
Ports: [corpora](../evidence/corpora-and-lanes.md), [jQuery](../evidence/jquery.md).
Plan: [reusable compression families](../../migration/record-2026-09.md#009-reusable-compression-families).
...
([registry](../history/compilation/decision-registry.md#aggregates-class-struct-object-record)).

...
Parent: [Config](../../config/README.md). Language: [aggregates](../../language/aggregates.md), [boundaries](../../language/boundaries-escape.md). Emission: [JavaScript emission](../compilation/javascript-emission.md).

...
Parent: [Compilation](../../compilation/README.md). Language: [modules](../../language/modules-lazy.md). Config: [`[bundle]`](../../config/bundle.md). Code: `plan_javascript_chunks`, `score_javascript_chunk_plan` in `src/compiler.rs`. Contract: [`docs/modules-and-delivery.md`](../../../modules-and-delivery.md).

...
Parent: [Compilation](../../compilation/README.md). Implementation: `src/compiler.rs` (`optimize_and_select_javascript`, `select_javascript_candidate`, `javascript_candidate_rank`). Config: [cost model](../config/cost-model.md), [priority](../config/javascript-priority.md). What is exact vs bounded search: [objectives](objectives.md).

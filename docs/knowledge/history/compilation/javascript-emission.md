...
Parent: [Compilation](../../compilation/README.md). Source: `src/codegen_ir_js.rs` (`IrJsOptions`, `IrJsEmitter`). Related: [peephole](peephole.md), [class identity](class-identity.md), [`[mangle]`](../config/mangle.md), [compression decisions](../config/compression-decisions.md).

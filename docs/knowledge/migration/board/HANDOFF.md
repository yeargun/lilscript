...
|---|---|---|
| LilScript | isolated candidate `fd3325b` atop pushed `main` | Green targeted gates, syntax floors, terminal admission, and partial V-01 |
...
The earlier checkpoints were pushed without force. Candidate `fd3325b` is pinned;

...
|---|---|---|
| LilScript | local `main` through callable ABI witness `b833c67` | Green targeted gates, phi safety, expanded matrix, and partial V-01 admission |
...
The earlier checkpoints were pushed without force. Candidate `b833c67` is pinned;

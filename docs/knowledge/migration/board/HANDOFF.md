...
|---|---|---|
| LilScript | local `main` through pre-score admission `114314c` | Green targeted gates, phi safety, expanded matrix, and partial V-01 admission |
...
The earlier checkpoints were pushed without force. Candidate `114314c` is pinned;

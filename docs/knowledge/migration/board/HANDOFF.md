...
|---|---|---|
| LilScript | isolated candidate `32f406d` atop pushed `main` | V-01 implementation complete under targeted gates; full G2 deferred |
...
The earlier checkpoints were pushed without force. Candidate `32f406d` is pinned;

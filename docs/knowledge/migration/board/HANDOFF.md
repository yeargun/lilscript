...
|---|---|---|
| LilScript | local `main` through property admission `7f43642` | Green targeted gates, phi safety, expanded matrix, and partial V-01 admission |
...
The earlier checkpoints were pushed without force. Candidate `7f43642` is pinned;

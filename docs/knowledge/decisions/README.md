...
These records explain choices behind existing implementations. The [architecture](../../future-architecture.md) carries them forward and may revisit them; they do not prescribe it. They do not define syntax, report live

...
Generated on 2026-08-06T15:16:10.718Z with LilScript `f72e0a4`, Node `v24.11.1`, Vite `8.2.0`, esbuild `0.28.1`, and Google Closure Compiler `20260803.0.0` on `darwin 24.6.0 arm64`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 1163 | 464 | 379 | +51.6% | 3.32 | +7.9% |
| Reference JS esbuild | 544 | 310 | 265 | +6.0% | 3.12 | +1.5% |
| JS Closure ADVANCED | 489 | 302 | 250 | 0.0% | 3.07 | 0.0% |
| JS hand-specialized | 245 | 194 | 170 | -32.0% | 2.92 | -5.1% |
| LilScript | 519 | 305 | 275 | +10.0% | 3.34 | +8.5% |
...
| --- | ---: | ---: | ---: | ---: |
| assets/index-BAb3oBAp.js<br>index.html | 4900 | 1932 | 1752 | 22.27 |
...
| Artifact | Raw | Gzip-9 | Brotli-11 | vs Closure Brotli | Median ms | vs Closure time |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 1033 | 393 | 320 | +61.6% | 1.63 | +7.1% |
| Reference JS esbuild | 506 | 280 | 244 | +23.2% | 1.53 | +0.2% |
| JS Closure ADVANCED | 351 | 244 | 198 | 0.0% | 1.52 | 0.0% |
| JS hand-specialized | 112 | 125 | 102 | -48.5% | 0.63 | -58.6% |
| LilScript | 315 | 227 | 192 | -3.0% | 1.60 | +5.0% |
...
| Vite production assets | Raw | Gzip-9 | Brotli-11 | Median ms |
| --- | ---: | ---: | ---: | ---: |
| assets/index-9bl6fb9B.js<br>index.html | 697 | 477 | 388 | 6.43 |
...
| Artifact | Raw | Gzip-9 | Brotli-11 | vs Closure Brotli | Median ms | vs Closure time |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 1208 | 489 | 441 | +48.0% | 10.64 | -0.7% |
| Reference JS esbuild | 545 | 327 | 299 | +0.3% | 10.68 | -0.3% |
| JS Closure ADVANCED | 521 | 319 | 298 | 0.0% | 10.71 | 0.0% |
| JS hand-specialized | 409 | 273 | 257 | -13.8% | 9.78 | -8.7% |
| LilScript | 604 | 370 | 333 | +11.7% | 10.67 | -0.4% |
...
| Artifact | Raw | Gzip-9 | Brotli-11 | vs Closure Brotli | Median ms | vs Closure time |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 884 | 395 | 332 | +57.3% | 1.17 | +4.1% |
| Reference JS esbuild | 361 | 258 | 214 | +1.4% | 1.18 | +5.2% |
| JS Closure ADVANCED | 335 | 257 | 211 | 0.0% | 1.13 | 0.0% |
| JS hand-specialized | 123 | 122 | 112 | -46.9% | 0.56 | -50.6% |
| LilScript | 277 | 226 | 191 | -9.5% | 1.13 | +0.3% |
...
| Artifact | Raw | Gzip-9 | Brotli-11 | vs Closure Brotli | Median ms | vs Closure time |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 698 | 360 | 305 | +113.3% | 0.88 | +20.6% |
| Reference JS esbuild | 270 | 205 | 174 | +21.7% | 0.87 | +18.6% |
| JS Closure ADVANCED | 144 | 146 | 143 | 0.0% | 0.73 | 0.0% |
| JS hand-specialized | 119 | 126 | 104 | -27.3% | 0.63 | -14.7% |
| LilScript | 164 | 155 | 133 | -7.0% | 0.70 | -4.0% |
| LilScript specialized source (diagnostic) | 133 | 137 | 106 | -25.9% | 0.59 | -20.0% |
...
| Vite production assets | Raw | Gzip-9 | Brotli-11 | Median ms |
| --- | ---: | ---: | ---: | ---: |
| assets/index-CZj057qH.js<br>index.html | 10571 | 4546 | 4152 | 2.29 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Reference JS bundle | 4986 | 2101 | 1777 | +61.5% | 1.076x |
| Reference JS esbuild | 2226 | 1380 | 1196 | +8.7% | 1.048x |
| JS Closure ADVANCED | 1840 | 1268 | 1100 | 0.0% | 1.000x |
| JS hand-specialized | 1008 | 840 | 745 | -32.3% | 0.685x |
| LilScript | 1879 | 1283 | 1124 | +2.2% | 1.018x |

...
var unified = (() => {
  ...
  function b(e2) {
    ...
    var r2 = Object.getPrototypeOf(e2), t2 = r2 == null || r2 === Object.prototype || Object.getPrototypeOf(r2) == null;
  ...
  function oe(e2, r2) {
    ...
    return function() {
      ...
      !s2 && (r3 && r3.then && "function" == typeof r3.then ? r3.then(o2, n2) : ne(r3) ? n2(r3) : o2(r3));
    };
  }
  function L(e2) {
  ...
  function se(e2) {
    ...
    return o2 < 0 ? "/" == e2.charAt(0) ? "/" : "." : 1 == o2 && "/" == e2.charAt(0) ? "//" : e2.slice(0, o2);
  }
  function ue(e2) {
    for (var a2, o2 = e2.length, n2 = -1, r2 = -1, t2 = 0, i2 = false; ; ) {
      if (o2 <= 0) {
        i2 = 0;
        break;
      }
      ...
      } else n2 < 0 && (n2 = o2 + 1, i2 = true), "." == a2 ? r2 < 0 ? r2 = o2 : 1 != t2 && (t2 = 1) : r2 > -1 && (t2 = -1);
    }
    return r2 < 0 || n2 < 0 || 0 == t2 || 1 == t2 && r2 == (n2 - 1 | 0) && r2 == (i2 + 1 | 0) ? "" : e2.slice(r2, n2);
  }
  function fe(e2, r2) {
    let t2 = "", o2 = 0, i2 = -1, a2 = 0, n2 = 0, s2;
    for (; n2 <= e2.length; ) {
      ...
      if ("/" == s2) {
        ...
        } else o2 = e2.slice(i2 + 1 | 0, n2), t2 = t2.length > 0 ? t2 + "/" + o2 : o2, o2 = (n2 - i2 | 0) - 1 | 0;
        i2 = n2, a2 = 0;
      } else a2 = "." == s2 && a2 > -1 ? a2 + 1 | 0 : -1;
      n2++;
    }
    return t2;
  }
  function ce(e2) {
    var t2 = "/" == e2.charAt(0), r2 = fe(e2, !t2);
    0 == r2.length && !t2 && (r2 = "."), r2.length > 0 && "/" == e2.charAt(e2.length - 1) && (r2 += "/");
    return t2 ? "/" + r2 : r2;
  }
  function F(e2) {
  ...
  function V(r2, t2, n2) {
    "string" == typeof t2 && (n2 = t2, t2 = void 0);
    var i2 = {};
    t2 && ("line" in t2 && "column" in t2 || "start" in t2 && "end" in t2 ? i2.place = t2 : "type" in t2 ? (i2.ancestors = [t2], i2.place = t2.position) : i2 = Object.assign(i2, t2));
    if ("string" == typeof r2) var o2, a2 = r2 + "", s2 = false;
    else !i2.cause && r2 ? (a2 = r2.message, i2.cause = r2, s2 = true) : (a2 = "", s2 = false);
    !i2.ruleId && !i2.source && "string" == typeof n2 && (r2 = n2 + "", t2 = r2.indexOf(":"), t2 < 0 ? i2.ruleId = r2 : (i2.source = r2.slice(0, t2), i2.ruleId = r2.slice(t2 + 1 | 0))), o2 = i2.ancestors, !i2.place && o2 && o2.length > 0 && (r2 = o2[o2.length - 1], i2.place = r2.position), t2 = i2.place, n2 = t2 && "start" in t2 ? t2.start : t2, r2 = new Error(), Object.setPrototypeOf(r2, e), r2.ancestors = void 0, o2 && (r2.ancestors = o2), r2.cause = void 0, i2.cause && (r2.cause = i2.cause), r2.column = void 0, n2 && (r2.column = n2.column), r2.fatal = void 0, r2.file = "", r2.message = a2, r2.line = void 0, n2 && (r2.line = n2.line), r2.name = le(t2), r2.place = void 0, t2 && (r2.place = t2), r2.reason = a2, r2.ruleId = void 0, i2.ruleId && (r2.ruleId = i2.ruleId), r2.source = void 0, i2.source && (r2.source = i2.source), r2.actual = void 0, r2.expected = void 0, r2.note = void 0, r2.url = void 0, r2.stack = s2 && "string" == typeof i2.cause.stack ? i2.cause.stack : "";
    return r2;
  }
  function f(e2, r2) {
  ...
  function x(e2, n2, r2) {
    for (var a2, s2, o2 = e2.length, i2 = -1; ; ) {
      if (false) {
        i2 = -1;
        break;
      }
    ...
    if (i2 == -1) {
      r2 = t.call(r2, 0), r2.unshift(n2), e2.push(r2);
      return;
    }
    if (r2.length > 0) {
      for (o2 = r2[0], s2 = t.call(r2, 1), a2 = e2[i2][1], b(a2) && b(o2) && (o2 = l(a2, o2)), r2 = [], r2.push(n2), r2.push(o2), o2 = s2.length, n2 = 0; n2 < o2; ) r2.push(s2[n2]), ++n2;
      re.call(e2, i2, 1, r2);
    }
  }
  function D(r2, t2, e2) {
    if (e2 != null) {
      Array.isArray(e2) || i("Expected a list of plugins, not `" + e2 + "`");
      for (var o2 = e2.length, n2 = -1; ++n2 < o2; ) pe(r2, t2, e2[n2]);
    }
  }
  function H(e2, r2, t2) {
  ...
  function M(r2) {
    for (var t2 = new n(), e2 = r2.attachers, o2 = e2.length, i2 = -1; ++i2 < o2; ) t2.use.apply(t2, e2[i2]);
    i2 = t2.data, t2.data(l({}, r2.namespace));
    return t2;
  }
  function r(e2, r2, t2) {
  ...
  var J = (0, function() {
    ...
    n2 = function() {
      ...
      e2 = s3, "function" == typeof c2 ? oe(c2, n2).apply(void 0, s3) : (i2 = t.call(s3), i2.unshift(g), r2.apply(void 0, i2));
    };
    var s2 = t.call(e2);
  ...
  var d = "history path basename stem extname dirname".split(" ");
  var e = {};
  ...
  var s = class VFile extends Object {
    constructor(e2) {
      ...
      for (var t2, n2 = 0; n2 < d.length; ) r2 = d[n2] || "", r2 in e2 && e2[r2] != null && e2[r2] !== void 0 && (t2 = e2[r2], "history" == r2 && (t2 = t2.slice()), this[r2] = t2), ++n2;
      for (r2 in e2) d.includes(r2) || (this[r2] = e2[r2]);
    }
  };
  var c = s.prototype;
  Object.defineProperty(s, "name", { configurable: true, value: "VFile" });
  ...
  f("basename", { configurable: true, get: function() {
    ...
    var e2 = o(this);
    if ("string" == typeof e2) return ue(e2 + "");
  }, set: function(e2) {
    m(e2, "extname");
    var r2 = this.dirname;
  ...
  var B = (0, function() {
    A("use", this.frozen);
    var e2, r2 = this.attachers, n2 = this.namespace;
  ...
  var X = (0, function(e2, r2) {
    this.freeze();
    let t2 = v(r2);
    r2 = I(this), P("stringify", r2), N(e2);
    return r2(e2, t2);
  });
  var Z = (0, function(e2, r2) {
    var t2 = this;
    t2.freeze(), j("process", E(t2)), P("process", I(t2));
    var n2 = function(n3, i2) {
      ...
      t2.run(a2, o2, function(e3, o3, a3) {
        ...
        ie(s2) ? a3.value = s2 : a3.result = s2;
        if (n3) {
          n3(a3);
          return;
        }
  ...
  var $ = (0, function(e2) {
    this.freeze(), j("processSync", E(this)), P("processSync", I(this));
    var r2, t2 = false;
  ...
  var ee = (0, function(e2, r2) {
    var t2, n2 = this.namespace, i2 = arguments.length;
    i2 > 0 && (t2 = e2);
    if ("string" == typeof t2) {
      if (2 == i2) return A("data", this.frozen), n2[t2] = r2, this;
      var o2;
      return a.call(n2, t2) && (o2 = n2[t2]) ? o2 : void 0;
    }
    return t2 ? (A("data", this.frozen), this.namespace = t2, this) : n2;
  });
  var te = (0, function() {
    if (this.frozen) return this;
    for (var r2 = this.attachers, i2 = this.transformers; true; ) {
      var e2 = +this.freezeIndex + 1;
      this.freezeIndex = e2;
      if (e2 >= r2.length) break;
      var n2 = r2[e2], o2 = n2[0];
      e2 = t.call(n2, 1);
      if (!(e2.length > 0 && e2[0] === false)) e2.length > 0 && true === e2[0] && re.call(e2, 0, 1, void 0), e2 = o2.apply(this, e2), "function" == typeof e2 && i2.use(e2);
    }
    this.frozen = true;
  ...
  var k = n.prototype;
  r("copy", G, 0), r("data", ee, 2), r("freeze", te, 0), r("parse", K, 1), r("process", Z, 2), r("processSync", $, 1), r("run", Q, 3), r("runSync", W, 2), r("stringify", X, 2), r("use", B, 1), Object.defineProperty(n, "prototype", { writable: false }), me = new n(), me.freeze();

...
ls_v5 = ls_from_u32(UINT32_C(13));
ls_v6 = (ls_t0){ls_v4,ls_v5};
ls_v7 = ls_v6;
ls_v8 = (ls_t1){ls_v3,ls_v7};
ls_v9 = ls_v8;
ls_c0 = ls_v9;
ls_v10 = ls_c0.ls_f1.ls_f0;
ls_v11 = ls_c0.ls_f0.ls_f0;
ls_v12 = ls_from_u32((uint32_t)((uint32_t)ls_v10 - (uint32_t)ls_v11));
printf("%ld\n",(long)ls_v12);
ls_v14 = ls_c0.ls_f1.ls_f1;
ls_v15 = ls_c0.ls_f0.ls_f1;

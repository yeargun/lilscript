...
return ls_value_float(array->items[index]);
}
...
static ls_value ls_fn1(bool ls_c2);
static void ls_fn2(ls_value ls_c3);
static void ls_init0(void) {
bool ls_v4;
ls_value ls_v5 = {0};
bool ls_v9;
ls_value ls_v10 = {0};
ls_v4 = true;
ls_value_take(&(ls_v5),ls_fn1(ls_v4));
ls_fn2(ls_v5);
ls_v9 = false;
ls_value_take(&(ls_v10),ls_fn1(ls_v9));
ls_fn2(ls_v10);
...
ls_object_take(&(ls_v2),ls_typed_new(ls_v1, 4));
{
ls_value ls_return = ls_value_object(ls_v2);
...
ls_v3 = ls_f64_bits(UINT64_C(0));
ls_v4 = ls_f64_bits(UINT64_C(0));
ls_array0_take(&(ls_v5),ls_array0_new(2));
ls_array0_push(ls_v5,ls_v3);
ls_array0_push(ls_v5,ls_v4);
{
ls_value ls_return = ls_value_array((ls_native_object *)ls_v5);
ls_value_retain(ls_return);
ls_array0_clear(&ls_v5);
return ls_return;
}
...
ls_value ls_v7 = {0};
int32_t ls_v8;
ls_value_copy(&(ls_v0),ls_c3);
ls_v1 = ls_from_u32(UINT32_C(0));
ls_v2 = ls_f64_bits(UINT64_C(4608308318706860032));
if (ls_v0.tag == LS_ARRAY) ls_array0_set((ls_array0 *)ls_v0.as.o,ls_v1,ls_v2);
else ls_typed_set_float32(ls_v0.as.o,ls_v1,ls_v2);
ls_value_copy(&(ls_v3),ls_c3);
ls_v4 = ls_from_u32(UINT32_C(0));
ls_v5 = (ls_v3.tag == LS_ARRAY ? ls_array0_get((ls_array0 *)ls_v3.as.o,ls_v4) : ls_typed_get_float32(ls_v3.as.o,ls_v4));
ls_print_number(ls_v5);
ls_value_copy(&(ls_v7),ls_c3);
ls_v8 = (ls_v7.tag == LS_ARRAY ? (int32_t)((ls_array0 *)ls_v7.as.o)->length : ls_typed_length(ls_v7.as.o));
printf("%ld\n",(long)ls_v8);

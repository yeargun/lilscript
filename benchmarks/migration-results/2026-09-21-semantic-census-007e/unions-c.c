...
static const uint16_t ls_s3[] = {104,101,108,108,111,};
#include <stdlib.h>
...
static bool *ls_g3(void) {
if (!ls_ready3) ls_native_unbound();
return &ls_c3;
}
static void ls_init0(void);
static bool ls_fn1(void);
static ls_value ls_fn2(bool ls_c8);
static void ls_init0(void) {
ls_value ls_c4 = {0};
ls_value ls_c5 = {0};
ls_array0 * ls_c6 = NULL;
...
ls_v11 = ls_c4;
ls_v12 = ls_c5;
ls_array0_take(&(ls_v13),ls_array0_new(2));
ls_array0_push(ls_v13,ls_v11);
ls_array0_push(ls_v13,ls_v12);
ls_array0_copy(&(ls_c6),ls_v13);
ls_v14 = (ls_string){NULL,0};
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_value_string(ls_v14);
ls_object_take(&(ls_v15),(ls_native_object *)ls_o);
}
ls_object_copy(&(ls_c7),ls_v15);
ls_v16 = ls_c4;
ls_print_value(ls_v16);
ls_v18 = ls_c5;
ls_print_value(ls_v18);
ls_array0_copy(&(ls_v20),ls_c6);
ls_v21 = ls_from_u32(UINT32_C(0));
ls_v22 = ls_array0_get(ls_v20,ls_v21);
ls_v23 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_v24 = ls_value_equal(ls_v22,ls_value_string(ls_v23));
puts(ls_v24 ? "true" : "false");
ls_array0_copy(&(ls_v26),ls_c6);
ls_v27 = ls_from_u32(UINT32_C(1));
ls_v28 = ls_array0_get(ls_v26,ls_v27);
ls_v29 = ls_from_u32(UINT32_C(42));
ls_v30 = ls_value_equal(ls_v28,ls_value_int(ls_v29));
puts(ls_v30 ? "true" : "false");
ls_object_copy(&(ls_v32),ls_c7);
ls_v33 = ((ls_object0 *)ls_v32)->ls_m0;
ls_v34 = (ls_string){NULL,0};
ls_v35 = ls_value_equal(ls_v33,ls_value_string(ls_v34));
puts(ls_v35 ? "true" : "false");
ls_object_clear(&ls_v32);
ls_array0_clear(&ls_v26);
ls_array0_clear(&ls_v20);
...
{
ls_value ls_return = ls_value_string(ls_v1);
return ls_return;
}
}
ls_v2 = ls_from_u32(UINT32_C(42));
{
ls_value ls_return = ls_value_int(ls_v2);
return ls_return;
}
}
int main(void) {

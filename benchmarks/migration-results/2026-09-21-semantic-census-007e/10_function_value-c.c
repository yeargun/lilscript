...
static int32_t ls_fn1(void *ls_env,int32_t ls_c1);
static ls_callable0 ls_closure1(void) {
return (ls_callable0){ls_fn1,NULL,ls_native_fresh_identity()};
}
static void ls_init0(void) {
ls_callable0 ls_c0 = {0};
ls_callable0 ls_v0 = {0};
ls_callable0 ls_v1 = {0};
int32_t ls_v2;
int32_t ls_v3;
ls_callable0_take(&(ls_v0),ls_closure1());
ls_callable0_copy(&(ls_c0),ls_v0);
ls_callable0_copy(&(ls_v1),ls_c0);
ls_v2 = ls_from_u32(UINT32_C(9));
ls_v3 = ls_v1.code(ls_v1.environment,ls_v2);
printf("%ld\n",(long)ls_v3);
ls_callable0_clear(&ls_v1);
ls_callable0_clear(&ls_c0);

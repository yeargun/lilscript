...
double ls_v71;
int32_t ls_v72;
ls_v0 = ls_f64_bits(UINT64_C(4609434218613702656));
ls_c0 = ls_v0;
ls_v1 = ls_f64_bits(UINT64_C(4609434218613702656));
ls_v2 = ls_f64(-(double)ls_v1);
ls_c1 = ls_v2;
ls_v3 = ls_f64_bits(UINT64_C(0));
ls_v4 = ls_f64(-(double)ls_v3);
ls_c2 = ls_v4;
ls_v5 = ls_c0;
ls_v6 = ls_f64(ls_round(ls_v5));
ls_print_number(ls_v6);
ls_v8 = ls_c1;
ls_v9 = ls_f64(ls_round(ls_v8));
ls_print_number(ls_v9);
ls_v11 = ls_c2;
ls_v12 = ls_f64(ls_round(ls_v11));
ls_v13 = ls_f64_bits(UINT64_C(4607182418800017408));
ls_v14 = ls_f64(-(double)ls_v13);
ls_v15 = ls_f64(atan2(ls_v12,(double)ls_v14));
ls_v16 = ls_f64_bits(UINT64_C(0));
ls_v17 = ls_v15 < ls_v16;
puts(ls_v17 ? "true" : "false");
ls_v19 = ls_f64_bits(UINT64_C(4621256167635550208));
ls_v20 = ls_f64(sqrt(ls_v19));
ls_print_number(ls_v20);
ls_v22 = ls_f64_bits(UINT64_C(0));
ls_v23 = ls_f64(sin(ls_v22));
ls_print_number(ls_v23);
ls_v25 = ls_f64_bits(UINT64_C(0));
ls_v26 = ls_f64(cos(ls_v25));
ls_print_number(ls_v26);
ls_v28 = ls_f64_bits(UINT64_C(4607182418800017408));
ls_v29 = ls_f64(acos(ls_v28));
ls_print_number(ls_v29);
ls_v31 = ls_f64_bits(UINT64_C(0));
ls_v32 = ls_f64(exp(ls_v31));
ls_print_number(ls_v32);
ls_v34 = ls_f64_bits(UINT64_C(4607182418800017408));
ls_v35 = ls_f64(log(ls_v34));
ls_print_number(ls_v35);
ls_v37 = ls_f64_bits(UINT64_C(0));
ls_v38 = ls_f64(tan(ls_v37));
ls_print_number(ls_v38);
ls_v40 = ls_f64_bits(UINT64_C(4607182418800017408));
ls_v41 = ls_f64_bits(UINT64_C(0));
ls_v42 = ls_f64(atan2(ls_v40,(double)ls_v41));
ls_c3 = ls_v42;
ls_v43 = ls_c3;
ls_v44 = ls_f64_bits(UINT64_C(4609434218613702656));
ls_v45 = ls_v43 > ls_v44;
ls_v49 = ls_v45;
if (ls_v45) {
ls_v46 = ls_c3;
ls_v47 = ls_f64_bits(UINT64_C(4609884578576439706));
ls_v48 = ls_v46 < ls_v47;
ls_v49 = ls_v48;
}
puts(ls_v49 ? "true" : "false");
ls_v51 = ls_f64_bits(UINT64_C(4613937818241073152));
ls_v52 = ls_f64_bits(UINT64_C(4616189618054758400));
ls_v53 = ls_f64(hypot(ls_v51,(double)ls_v52));
ls_print_number(ls_v53);
ls_v55 = ls_f64_bits(UINT64_C(4615964438073389875));
ls_v56 = ls_to_i32(ls_v55);
printf("%ld\n",(long)ls_v56);
ls_v58 = ls_f64_bits(UINT64_C(4615964438073389875));
ls_v59 = ls_f64(-(double)ls_v58);
ls_v60 = ls_to_i32(ls_v59);
printf("%ld\n",(long)ls_v60);
ls_v62 = ls_f64_bits(UINT64_C(4751297606876921856));
ls_v63 = ls_to_i32(ls_v62);
printf("%ld\n",(long)ls_v63);
ls_v65 = ls_f64_bits(UINT64_C(4746794007248502784));
ls_v66 = ls_to_i32(ls_v65);
printf("%ld\n",(long)ls_v66);
ls_v68 = ls_f64_bits(UINT64_C(4607182418800017408));
ls_v69 = ls_f64_bits(UINT64_C(0));
ls_v70 = ls_f64((double)ls_v68 / (double)ls_v69);
ls_c4 = ls_v70;
ls_v71 = ls_c4;
ls_v72 = ls_to_i32(ls_v71);
printf("%ld\n",(long)ls_v72);
}
int main(void) {

...
static inline int32_t ls_callable2_call(ls_callable2 value,int32_t ls_p0) {
ls_native_retain(value.environment);
...
static ls_value ls_array0_optional(ls_array0 *array, int32_t index) {
...
static const uint16_t ls_s8[] = {104,101,108,108,111,};
static const uint16_t ls_s9[] = {110,117,109,98,101,114,45,};
static const uint16_t ls_s10[] = {114,101,97,100,121,};
static const uint16_t ls_s11[] = {114,101,115,117,108,116,45,};
static const uint16_t ls_s12[] = {102,105,114,115,116,45,};
static const uint16_t ls_s13[] = {109,97,121,98,101,};
static const uint16_t ls_s14[] = {110,111,110,101,};
#include <stdlib.h>
...
static bool *ls_g8(void) {
if (!ls_ready8) ls_native_unbound();
return &ls_c8;
}
static int32_t ls_c9;
static bool ls_ready9;
static int32_t *ls_g9(void) {
if (!ls_ready9) ls_native_unbound();
return &ls_c9;
}
static void ls_init0(void);
static ls_value ls_fn1(void);
static ls_string ls_fn2(ls_value ls_c10);
static int32_t ls_fn3(int32_t ls_c11);
static ls_value ls_fn4(void);
static ls_string ls_fn5(ls_value ls_c12);
static ls_string ls_fn6(ls_value ls_c13);
static ls_value ls_fn7(void);
static ls_string ls_fn8(ls_value ls_c14);
...
ls_ready9 = true;
ls_v12 = ls_fn1();
ls_v13 = ls_fn2(ls_v12);
ls_print_string(ls_v13);
ls_v17 = ls_fn1();
ls_v18 = ls_fn2(ls_v17);
ls_print_string(ls_v18);
ls_value_take(&(ls_v22),ls_fn4());
ls_v23 = ls_fn5(ls_v22);
ls_print_string(ls_v23);
ls_value_take(&(ls_v27),ls_fn4());
ls_v28 = ls_fn5(ls_v27);
ls_print_string(ls_v28);
ls_v31 = ls_from_u32(UINT32_C(7));
ls_v32 = ls_from_u32(UINT32_C(8));
ls_array0_take(&(ls_v33),ls_array0_new(2));
ls_array0_push(ls_v33,ls_v31);
ls_array0_push(ls_v33,ls_v32);
ls_v34 = ls_fn6(ls_value_array((ls_native_object *)ls_v33));
ls_print_string(ls_v34);
ls_v37 = (ls_string){ls_s14,sizeof ls_s14/sizeof *ls_s14};
ls_v38 = ls_fn6(ls_value_string(ls_v37));
ls_print_string(ls_v38);
ls_v42 = ls_fn7();
ls_v43 = ls_fn8(ls_v42);
ls_print_string(ls_v43);
ls_v47 = ls_fn7();
ls_v48 = ls_fn8(ls_v47);
ls_print_string(ls_v48);
ls_v52 = ls_fn7();
ls_v53 = ls_fn8(ls_v52);
ls_print_string(ls_v53);
ls_array0_clear(&ls_v33);
...
ls_v2 = (*ls_g8());
if (ls_v2) {
ls_v3 = (ls_string){ls_s8,sizeof ls_s8/sizeof *ls_s8};
{
ls_value ls_return = ls_value_string(ls_v3);
return ls_return;
}
}
ls_v4 = ls_from_u32(UINT32_C(42));
{
ls_value ls_return = ls_value_int(ls_v4);
return ls_return;
}
}
static ls_string ls_fn2(ls_value ls_c10) {
...
if (ls_v1) {
ls_v2 = ls_value_to_string(ls_c10);
ls_v3 = ls_string_case(ls_v2,true);
{
ls_string ls_return = ls_v3;
return ls_return;
}
}
ls_v4 = (ls_string){ls_s9,sizeof ls_s9/sizeof *ls_s9};
ls_v5 = ls_value_to_int(ls_c10);
ls_v6 = ls_string_concat(ls_v4,ls_int_to_string(ls_v5));
{
ls_string ls_return = ls_v6;
return ls_return;
}
}
static int32_t ls_fn3(int32_t ls_c11) {
...
if (ls_v2) {
{
ls_value ls_return = ls_value_callable2((ls_callable2){ls_adapter3,NULL,UINT64_C(4)});
ls_value_retain(ls_return);
return ls_return;
}
}
ls_v4 = (ls_string){ls_s10,sizeof ls_s10/sizeof *ls_s10};
{
...
bool ls_v1;
ls_string ls_v2;
ls_callable2 ls_v3 = {0};
int32_t ls_v4;
int32_t ls_v5;
ls_string ls_v6;
ls_string ls_v7;
ls_value_copy(&(ls_v0),ls_c12);
{ uint8_t ls_t = ls_v0.tag; ls_v1 = ls_t == LS_CALLABLE; }
if (ls_v1) {
ls_v2 = (ls_string){ls_s11,sizeof ls_s11/sizeof *ls_s11};
ls_callable2_copy(&(ls_v3),ls_value_to_callable2(ls_c12));
ls_v4 = ls_from_u32(UINT32_C(4));
ls_v5 = ls_v3.code(ls_v3.environment,ls_v4);
ls_v6 = ls_string_concat(ls_v2,ls_int_to_string(ls_v5));
{
ls_string ls_return = ls_v6;
ls_callable2_clear(&ls_v3);
...
ls_v7 = ls_value_to_string(ls_c12);
{
ls_string ls_return = ls_v7;
ls_value_clear(&ls_v0);
ls_value_clear(&ls_c12);
return ls_return;
}
...
{ uint8_t ls_t = ls_v0.tag; ls_v1 = ls_t == LS_STRING; }
if (ls_v1) {
ls_v2 = ls_value_to_string(ls_c13);
{
ls_string ls_return = ls_v2;
ls_value_clear(&ls_v0);
ls_value_clear(&ls_c13);
return ls_return;
}
} else {
ls_v3 = (ls_string){ls_s12,sizeof ls_s12/sizeof *ls_s12};
ls_array0_copy(&(ls_v4),(ls_array0 *)ls_value_to_array(ls_c13));
ls_v5 = ls_from_u32(UINT32_C(0));
ls_v6 = ls_array0_get(ls_v4,ls_v5);
ls_v7 = ls_string_concat(ls_v3,ls_int_to_string(ls_v6));
{
ls_string ls_return = ls_v7;
...
ls_v9 = ls_v7 == ls_v8;
if (ls_v9) {
ls_v10 = (ls_string){ls_s13,sizeof ls_s13/sizeof *ls_s13};
{
ls_value ls_return = ls_value_string(ls_v10);
return ls_return;
}
}
ls_v11 = ls_from_u32(UINT32_C(9));
{
ls_value ls_return = ls_value_int(ls_v11);
return ls_return;
}
}
static ls_string ls_fn8(ls_value ls_c14) {
...
if (ls_v2) {
ls_v3 = (ls_string){ls_s14,sizeof ls_s14/sizeof *ls_s14};
{
ls_string ls_return = ls_v3;
return ls_return;
}
...
ls_v4 = ls_c14;
{ uint8_t ls_t = ls_v4.tag; ls_v5 = ls_t == LS_STRING; }
if (ls_v5) {
ls_v6 = ls_value_to_string(ls_c14);
ls_v7 = ls_string_case(ls_v6,true);
{
ls_string ls_return = ls_v7;
return ls_return;
}
}
ls_v8 = (ls_string){ls_s9,sizeof ls_s9/sizeof *ls_s9};
ls_v9 = ls_value_to_int(ls_c14);
ls_v10 = ls_string_concat(ls_v8,ls_int_to_string(ls_v9));
{

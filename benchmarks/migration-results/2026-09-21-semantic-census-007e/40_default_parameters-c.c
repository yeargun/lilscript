...
static inline int32_t ls_callable1_call(ls_callable1 value,int32_t ls_p0,int32_t ls_p1) {
ls_native_retain(value.environment);
...
static const uint16_t ls_s6[] = {110,111,110,101,};
static void ls_init0(void);
static int32_t ls_fn1(int32_t ls_c5,int32_t ls_c6);
static int32_t ls_fn2(int32_t ls_c7);
static ls_string ls_fn3(ls_value ls_c8);
static void ls_fn4(ls_native_object * ls_c9,int32_t ls_c10);
static int32_t ls_fn5(ls_native_object * ls_c11,int32_t ls_c12);
static int32_t ls_adapter1(void *environment,int32_t ls_p0,int32_t ls_p1) {
(void)environment;
return ls_fn1(ls_p0,ls_p1);
}
static void ls_init0(void) {
ls_callable1 ls_c13 = {0};
...
int32_t ls_v31;
int32_t ls_v32;
ls_callable1_copy(&(ls_c13),(ls_callable1){ls_adapter1,NULL,UINT64_C(2)});
...
ls_v9 = ls_from_u32(UINT32_C(10));
ls_fn4(ls_v7,ls_v9);
ls_object_copy(&(ls_c4),ls_v7);
ls_v12 = ls_from_u32(UINT32_C(3));
ls_v13 = ls_from_u32(UINT32_C(2));
ls_v14 = ls_fn1(ls_v12,ls_v13);
printf("%ld\n",(long)ls_v14);
ls_callable1_copy(&(ls_v16),ls_c13);
ls_v17 = ls_from_u32(UINT32_C(4));
ls_v18 = ls_from_u32(UINT32_C(2));
ls_v19 = ls_v16.code(ls_v16.environment,ls_v17,ls_v18);
printf("%ld\n",(long)ls_v19);
ls_v22 = ls_from_u32(UINT32_C(4294967294));
ls_v23 = ls_fn2(ls_v22);
printf("%ld\n",(long)ls_v23);
ls_v26 = (ls_value){0};
ls_v27 = ls_fn3(ls_v26);
ls_print_string(ls_v27);
ls_object_copy(&(ls_v29),ls_c4);
ls_v31 = ls_from_u32(UINT32_C(3));
ls_v32 = ls_fn5(ls_v29,ls_v31);
printf("%ld\n",(long)ls_v32);
ls_object_clear(&ls_v29);
ls_callable1_clear(&ls_v16);
ls_object_clear(&ls_c4);
ls_object_clear(&ls_v7);
ls_callable1_clear(&ls_c13);
}
static int32_t ls_fn1(int32_t ls_c5,int32_t ls_c6) {
int32_t ls_v0;
bool ls_v1;
...
ls_v1 = false;
if (ls_v1) {
ls_v2 = ls_from_u32(UINT32_C(4294967294));
ls_c7 = ls_v2;
}
ls_v3 = ls_c7;
ls_v4 = ls_from_u32(UINT32_C(5));
ls_v5 = ls_from_u32((uint32_t)((uint32_t)ls_v3 + (uint32_t)ls_v4));
{
int32_t ls_return = ls_v5;
return ls_return;
}
...
if (ls_v5) {
ls_v6 = (ls_string){ls_s6,sizeof ls_s6/sizeof *ls_s6};
{
ls_string ls_return = ls_v6;
return ls_return;
}
} else {
ls_v7 = ls_value_to_string(ls_c8);
{

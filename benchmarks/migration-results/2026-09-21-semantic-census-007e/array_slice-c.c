...
ls_array0 * ls_v38 = NULL;
int32_t ls_v39;
ls_array0 * ls_v41 = NULL;
int32_t ls_v42;
int32_t ls_v43;
ls_array0 * ls_v45 = NULL;
int32_t ls_v46;
int32_t ls_v47;
ls_array0 * ls_v49 = NULL;
int32_t ls_v50;
int32_t ls_v51;
ls_array0 * ls_v52 = NULL;
ls_array0 * ls_v53 = NULL;
int32_t ls_v54;
ls_v0 = ls_from_u32(UINT32_C(1));
ls_v1 = ls_from_u32(UINT32_C(2));
ls_v2 = ls_from_u32(UINT32_C(3));
ls_v3 = ls_from_u32(UINT32_C(4));
ls_array0_take(&(ls_v4),ls_array0_new(4));
ls_array0_push(ls_v4,ls_v0);
...
ls_array0_take(&(ls_v6),ls_array0_slice(ls_v5, 0, ls_v5->length));
ls_array0_copy(&(ls_c1),ls_v6);
ls_array0_copy(&(ls_v7),ls_c1);
ls_v8 = ls_from_u32(UINT32_C(0));
ls_v9 = ls_from_u32(UINT32_C(9));
ls_array0_set(ls_v7,ls_v8,ls_v9);
ls_array0_copy(&(ls_v10),ls_c0);
ls_v11 = ls_from_u32(UINT32_C(0));
ls_v12 = ls_array0_get(ls_v10,ls_v11);
printf("%ld\n",(long)ls_v12);
ls_array0_copy(&(ls_v14),ls_c1);
ls_v15 = ls_from_u32(UINT32_C(0));
ls_v16 = ls_array0_get(ls_v14,ls_v15);
printf("%ld\n",(long)ls_v16);
ls_array0_copy(&(ls_v18),ls_c0);
ls_v19 = ls_from_u32(UINT32_C(1));
ls_v20 = ls_from_u32(UINT32_C(1));
ls_v21 = ls_from_u32((uint32_t)(UINT32_C(0) - (uint32_t)ls_v20));
ls_array0_take(&(ls_v22),ls_array0_slice(ls_v18, ls_array_relative(ls_v19, ls_v18->length), ls_array_relative(ls_v21, ls_v18->length)));
ls_array0_copy(&(ls_c2),ls_v22);
ls_array0_copy(&(ls_v23),ls_c2);
ls_v24 = (int32_t)ls_v23->length;
printf("%ld\n",(long)ls_v24);
ls_array0_copy(&(ls_v26),ls_c2);
ls_v27 = ls_from_u32(UINT32_C(0));
ls_v28 = ls_array0_get(ls_v26,ls_v27);
printf("%ld\n",(long)ls_v28);
ls_array0_copy(&(ls_v30),ls_c2);
ls_v31 = ls_from_u32(UINT32_C(1));
ls_v32 = ls_array0_get(ls_v30,ls_v31);
printf("%ld\n",(long)ls_v32);
ls_array0_copy(&(ls_v34),ls_c0);
ls_v35 = ls_from_u32(UINT32_C(2));
ls_v36 = ls_from_u32((uint32_t)(UINT32_C(0) - (uint32_t)ls_v35));
ls_array0_take(&(ls_v37),ls_array0_slice(ls_v34, ls_array_relative(ls_v36, ls_v34->length), ls_v34->length));
ls_array0_copy(&(ls_c3),ls_v37);
ls_array0_copy(&(ls_v38),ls_c3);
ls_v39 = (int32_t)ls_v38->length;
printf("%ld\n",(long)ls_v39);
ls_array0_copy(&(ls_v41),ls_c3);
ls_v42 = ls_from_u32(UINT32_C(0));
ls_v43 = ls_array0_get(ls_v41,ls_v42);
printf("%ld\n",(long)ls_v43);
ls_array0_copy(&(ls_v45),ls_c3);
ls_v46 = ls_from_u32(UINT32_C(1));
ls_v47 = ls_array0_get(ls_v45,ls_v46);
printf("%ld\n",(long)ls_v47);
ls_array0_copy(&(ls_v49),ls_c0);
ls_v50 = ls_from_u32(UINT32_C(3));
ls_v51 = ls_from_u32(UINT32_C(1));
ls_array0_take(&(ls_v52),ls_array0_slice(ls_v49, ls_array_relative(ls_v50, ls_v49->length), ls_array_relative(ls_v51, ls_v49->length)));
ls_array0_copy(&(ls_c4),ls_v52);
ls_array0_copy(&(ls_v53),ls_c4);
ls_v54 = (int32_t)ls_v53->length;
printf("%ld\n",(long)ls_v54);
ls_array0_clear(&ls_v53);
ls_array0_clear(&ls_c4);
ls_array0_clear(&ls_v52);
ls_array0_clear(&ls_v49);
ls_array0_clear(&ls_v45);
ls_array0_clear(&ls_v41);
ls_array0_clear(&ls_v38);
ls_array0_clear(&ls_c3);
ls_array0_clear(&ls_v37);
ls_array0_clear(&ls_v34);
ls_array0_clear(&ls_v30);
ls_array0_clear(&ls_v26);
ls_array0_clear(&ls_v23);
ls_array0_clear(&ls_c2);
ls_array0_clear(&ls_v22);
ls_array0_clear(&ls_v18);
ls_array0_clear(&ls_v14);
ls_array0_clear(&ls_v10);
ls_array0_clear(&ls_v7);
ls_array0_clear(&ls_c1);

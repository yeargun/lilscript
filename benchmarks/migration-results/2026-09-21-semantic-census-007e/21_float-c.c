...
double ls_v29;
double ls_v30;
ls_v0 = ls_f64_bits(UINT64_C(4615063718147915776));
ls_c0 = ls_v0;
ls_v1 = ls_f64_bits(UINT64_C(4611686018427387904));
ls_c1 = ls_v1;
ls_v2 = ls_c0;
ls_v3 = ls_c1;
ls_v4 = ls_f64((double)ls_v2 * (double)ls_v3);
ls_c2 = ls_v4;
ls_v5 = ls_c2;
ls_print_number(ls_v5);
ls_v7 = ls_c2;
ls_v8 = ls_f64_bits(UINT64_C(4619567317775286272));
ls_v9 = ls_v7 >= ls_v8;
puts(ls_v9 ? "true" : "false");
ls_v11 = ls_f64_bits(UINT64_C(4615063718147915776));
ls_v12 = ls_f64(-(double)ls_v11);
ls_c3 = ls_v12;
ls_v13 = ls_c3;
ls_v14 = ls_f64(fabs(ls_v13));
ls_print_number(ls_v14);
ls_v16 = ls_c3;
ls_v17 = ls_f64(floor(ls_v16));
ls_print_number(ls_v17);
ls_v19 = ls_c3;
ls_v20 = ls_f64(ceil(ls_v19));
ls_print_number(ls_v20);
ls_v22 = ls_c3;
ls_v23 = ls_f64_bits(UINT64_C(4619567317775286272));
ls_v24 = ls_f64(-(double)ls_v23);
ls_v25 = ls_f64(ls_min(ls_v22,(double)ls_v24));
ls_print_number(ls_v25);
ls_v27 = ls_c3;
ls_v28 = ls_f64_bits(UINT64_C(4611686018427387904));
ls_v29 = ls_f64(-(double)ls_v28);
ls_v30 = ls_f64(ls_max(ls_v27,(double)ls_v29));
ls_print_number(ls_v30);
}
int main(void) {

...
static inline ls_value ls_callable1_call(ls_callable1 value,ls_value ls_p0) {
ls_native_retain(value.environment);
...
typedef struct {
ls_native_object * (*code)(void *,ls_value,ls_callable1);
void *environment;
uint64_t identity;
} ls_callable2;
static inline ls_callable2 ls_callable2_retain(ls_callable2 value) {
ls_native_retain(value.environment);
return value;
}
static inline void ls_callable2_release(ls_callable2 value) { ls_native_release(value.environment); }
static inline void ls_callable2_copy(ls_callable2 *destination, ls_callable2 value) {
ls_native_retain(value.environment);
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable2_take(ls_callable2 *destination, ls_callable2 value) {
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable2_clear(ls_callable2 *destination) {
ls_native_release(destination->environment);
*destination = (ls_callable2){0};
}
static inline ls_native_object * ls_callable2_call(ls_callable2 value,ls_value ls_p0,ls_callable1 ls_p1) {
ls_native_retain(value.environment);
ls_native_object * result = value.code(value.environment,ls_p0,ls_p1);
ls_native_release(value.environment);
return result;
}
typedef struct {
...
static inline ls_callable10 ls_callable10_retain(ls_callable10 value) {
ls_native_retain(value.environment);
return value;
}
static inline void ls_callable10_release(ls_callable10 value) { ls_native_release(value.environment); }
static inline void ls_callable10_copy(ls_callable10 *destination, ls_callable10 value) {
ls_native_retain(value.environment);
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable10_take(ls_callable10 *destination, ls_callable10 value) {
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable10_clear(ls_callable10 *destination) {
ls_native_release(destination->environment);
*destination = (ls_callable10){0};
}
static inline int32_t ls_callable10_call(ls_callable10 value,int32_t ls_p0) {
ls_native_retain(value.environment);
...
static ls_value ls_value_callable1(ls_callable1 value) { ls_value result = {LS_CALLABLE, 1}; memcpy(&result.as.c, &value, sizeof value); return result; }
static ls_callable1 ls_value_to_callable1(ls_value value) {
...
static ls_value ls_value_callable2(ls_callable2 value) { ls_value result = {LS_CALLABLE, 2}; memcpy(&result.as.c, &value, sizeof value); return result; }
static ls_callable2 ls_value_to_callable2(ls_value value) {
...
_Static_assert(sizeof(ls_callable10) == sizeof(((ls_value *)0)->as.c), "callable layout");
static ls_value ls_value_callable10(ls_callable10 value) { ls_value result = {LS_CALLABLE, 10}; memcpy(&result.as.c, &value, sizeof value); return result; }
static ls_callable10 ls_value_to_callable10(ls_value value) {
if (value.tag == LS_NULL) return (ls_callable10){0};
if (value.tag != LS_CALLABLE || value.signature != 10) ls_value_mismatch();
ls_callable10 result; memcpy(&result, &value.as.c, sizeof result); return result;
}
typedef struct { ls_native_object owner; ls_callable10 inner; } ls_adapter10_1;
static void ls_adapter10_1_destroy(ls_native_object *owner) { ls_callable10_clear(&((ls_adapter10_1 *)owner)->inner); }
static ls_value ls_adapter10_1_code(void *environment,ls_value ls_p0) {
ls_adapter10_1 *adapter = environment;
return ls_value_int(adapter->inner.code(adapter->inner.environment,ls_value_to_int(ls_p0)));
}
static ls_callable1 ls_adapt10_1(ls_callable10 inner) {
ls_adapter10_1 *adapter = ls_native_allocate(sizeof *adapter, ls_adapter10_1_destroy);
ls_native_retain(inner.environment);
adapter->inner = inner;
return (ls_callable1){ls_adapter10_1_code, adapter, inner.identity};
}
static ls_value ls_adapt_value10_1(ls_value value) {
if (value.tag != LS_CALLABLE) { ls_value_retain(value); return value; }
return ls_value_callable1(ls_adapt10_1(ls_value_to_callable10(value)));
}
...
typedef struct ls_object1 {
ls_native_object owner;
ls_value ls_m0;
ls_callable1 ls_m1;
} ls_object1;
static void ls_object1_clear_fields(ls_object1 *object) {
(void)object;
ls_value_clear(&object->ls_m0);
ls_callable1_clear(&object->ls_m1);
}
static void ls_object1_destroy(ls_native_object *owner) { ls_object1_clear_fields((ls_object1 *)owner); }
static void ls_init0(void);
static ls_value ls_fn1(ls_value ls_c7);
static ls_value ls_fn2(ls_value ls_c8,ls_callable1 ls_c9);
static void ls_fn3(ls_native_object * ls_c10,ls_value ls_c11);
static ls_value ls_fn4(ls_native_object * ls_c12);
static void ls_fn5(ls_native_object * ls_c13,ls_value ls_c14,ls_callable1 ls_c15);
static ls_value ls_fn6(ls_native_object * ls_c16);
static int32_t ls_fn7(void *ls_env,int32_t ls_c17);
static int32_t ls_fn8(void *ls_env,int32_t ls_c18);
static ls_callable10 ls_closure7(void) {
return (ls_callable10){ls_fn7,NULL,ls_native_fresh_identity()};
}
static ls_callable10 ls_closure8(void) {
return (ls_callable10){ls_fn8,NULL,ls_native_fresh_identity()};
}
static void ls_init0(void) {
int32_t ls_c4;
...
int32_t ls_v19;
int32_t ls_v22;
ls_callable10 ls_v23 = {0};
int32_t ls_v24;
ls_value ls_v26 = {0};
ls_value ls_v27 = {0};
ls_native_object * ls_v28 = NULL;
int32_t ls_v30;
ls_callable10 ls_v31 = {0};
ls_native_object * ls_v33 = NULL;
int32_t ls_v35;
ls_v6 = ls_from_u32(UINT32_C(6));
ls_c4 = ls_v6;
ls_v7 = ls_c4;
ls_v8 = ls_from_u32(UINT32_C(1));
ls_v9 = ls_from_u32((uint32_t)((uint32_t)ls_v7 + (uint32_t)ls_v8));
ls_c4 = ls_v9;
ls_v10 = (ls_value){0};
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v10;
ls_value_retain(((ls_object0 *)ls_o)->ls_m0);
ls_object_take(&(ls_v11),(ls_native_object *)ls_o);
}
ls_v13 = ls_c4;
ls_fn3(ls_v11,ls_value_int(ls_v13));
ls_object_copy(&(ls_c5),ls_v11);
ls_object_copy(&(ls_v16),ls_c5);
ls_v18 = ls_value_to_int(ls_fn4(ls_v16));
ls_v19 = ls_value_to_int(ls_fn1(ls_value_int(ls_v18)));
printf("%ld\n",(long)ls_v19);
ls_v22 = ls_from_u32(UINT32_C(3));
ls_callable10_take(&(ls_v23),ls_closure7());
{
ls_callable1 ls_adapted1 = ls_adapt10_1(ls_v23);
ls_v24 = ls_value_to_int(ls_fn2(ls_value_int(ls_v22),ls_adapted1));
ls_callable1_clear(&ls_adapted1);
}
printf("%ld\n",(long)ls_v24);
ls_v26 = (ls_value){0};
ls_v27 = (ls_value){0};
{
ls_object1 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object1_destroy);
((ls_object1 *)ls_o)->ls_m0 = ls_v26;
ls_value_retain(((ls_object1 *)ls_o)->ls_m0);
((ls_object1 *)ls_o)->ls_m1 = ls_value_to_callable1(ls_v27);
ls_native_retain(((ls_object1 *)ls_o)->ls_m1.environment);
ls_object_take(&(ls_v28),(ls_native_object *)ls_o);
}
ls_v30 = ls_from_u32(UINT32_C(2));
ls_callable10_take(&(ls_v31),ls_closure8());
{
ls_callable1 ls_adapted2 = ls_adapt10_1(ls_v31);
ls_fn5(ls_v28,ls_value_int(ls_v30),ls_adapted2);
ls_callable1_clear(&ls_adapted2);
}
ls_object_copy(&(ls_c6),ls_v28);
ls_object_copy(&(ls_v33),ls_c6);
ls_v35 = ls_value_to_int(ls_fn6(ls_v33));
printf("%ld\n",(long)ls_v35);
ls_object_clear(&ls_v33);
ls_object_clear(&ls_c6);
ls_callable10_clear(&ls_v31);
ls_object_clear(&ls_v28);
ls_callable10_clear(&ls_v23);
ls_object_clear(&ls_v16);
ls_object_clear(&ls_c5);
ls_object_clear(&ls_v11);
}
static ls_value ls_fn1(ls_value ls_c7) {
ls_value_retain(ls_c7);
ls_value ls_v0 = {0};
ls_value ls_v1 = {0};
ls_value_copy(&(ls_v0),ls_c7);
...
static ls_value ls_fn2(ls_value ls_c8,ls_callable1 ls_c9) {
ls_value_retain(ls_c8);
ls_native_retain(ls_c9.environment);
ls_callable1 ls_v0 = {0};
ls_value ls_v1 = {0};
ls_value ls_v2 = {0};
ls_value ls_v3 = {0};
ls_value ls_v4 = {0};
ls_callable1_copy(&(ls_v0),ls_c9);
ls_value_copy(&(ls_v1),ls_c8);
...
ls_callable1_clear(&ls_c9);
ls_value_clear(&ls_c8);
return ls_return;
}
ls_value_clear(&ls_v4);
ls_value_clear(&ls_v3);
...
static void ls_fn3(ls_native_object * ls_c10,ls_value ls_c11) {
ls_native_retain(ls_c10);
ls_value_retain(ls_c11);
ls_native_object * ls_v0 = NULL;
ls_value ls_v1 = {0};
ls_value ls_v2 = {0};
ls_object_copy(&(ls_v0),ls_c10);
ls_value_copy(&(ls_v1),ls_c11);
ls_value_copy(&(ls_v2),ls_v1);
ls_value_copy(&(((ls_object0 *)ls_v0)->ls_m0),ls_v2);
ls_value_clear(&ls_v2);
ls_value_clear(&ls_v1);
ls_object_clear(&ls_v0);
ls_value_clear(&ls_c11);
ls_object_clear(&ls_c10);
}
static ls_value ls_fn4(ls_native_object * ls_c12) {
ls_native_retain(ls_c12);
ls_native_object * ls_v0 = NULL;
ls_value ls_v1 = {0};
ls_value ls_v2 = {0};
ls_object_copy(&(ls_v0),ls_c12);
ls_value_copy(&(ls_v1),((ls_object0 *)ls_v0)->ls_m0);
ls_value_copy(&(ls_v2),ls_v1);
{
...
ls_callable1 ls_v4 = {0};
ls_object_copy(&(ls_v0),ls_c13);
ls_value_copy(&(ls_v1),ls_c14);
ls_value_copy(&(ls_v2),ls_v1);
ls_value_copy(&(((ls_object1 *)ls_v0)->ls_m0),ls_v2);
ls_object_copy(&(ls_v3),ls_c13);
ls_callable1_copy(&(ls_v4),ls_c15);
ls_callable1_copy(&(((ls_object1 *)ls_v3)->ls_m1),ls_v4);
ls_callable1_clear(&ls_v4);
ls_object_clear(&ls_v3);
ls_value_clear(&ls_v2);
ls_value_clear(&ls_v1);
ls_object_clear(&ls_v0);
ls_callable1_clear(&ls_c15);
ls_value_clear(&ls_c14);
ls_object_clear(&ls_c13);
}
static ls_value ls_fn6(ls_native_object * ls_c16) {
ls_native_retain(ls_c16);
ls_native_object * ls_v0 = NULL;
...
ls_value ls_v8 = {0};
ls_value ls_v9 = {0};
ls_callable1 ls_pc0 = {0};
ls_object_copy(&(ls_v0),ls_c16);
ls_object_copy(&(ls_v1),ls_c16);
ls_callable1_copy(&ls_pc0,((ls_object1 *)ls_v1)->ls_m1);
ls_object_copy(&(ls_v2),ls_c16);
ls_value_copy(&(ls_v3),((ls_object1 *)ls_v2)->ls_m0);
ls_value_copy(&(ls_v4),ls_v3);
ls_value_take(&(ls_v5),ls_pc0.code(ls_pc0.environment,ls_v4));
ls_callable1_clear(&ls_pc0);
ls_value_copy(&(ls_v6),ls_v5);
ls_value_copy(&(((ls_object1 *)ls_v0)->ls_m0),ls_v6);
ls_object_copy(&(ls_v7),ls_c16);
ls_value_copy(&(ls_v8),((ls_object1 *)ls_v7)->ls_m0);
ls_value_copy(&(ls_v9),ls_v8);
{
ls_value ls_return = ls_v9;
ls_value_retain(ls_return);
ls_value_clear(&ls_v9);
ls_value_clear(&ls_v8);
ls_object_clear(&ls_v7);
ls_value_clear(&ls_v6);
ls_value_clear(&ls_v5);
ls_value_clear(&ls_v4);
ls_value_clear(&ls_v3);
ls_object_clear(&ls_v2);
ls_object_clear(&ls_v1);
ls_object_clear(&ls_v0);
ls_object_clear(&ls_c16);
return ls_return;
}
ls_value_clear(&ls_v9);
ls_value_clear(&ls_v8);

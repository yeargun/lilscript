...
static void ls_fn1(ls_native_object * ls_c2);
static void ls_fn2(ls_native_object * ls_c3,int32_t ls_c4);
static int32_t ls_fn3(ls_native_object * ls_c5);
static void ls_init0(void) {
...
ls_v10 = ls_v8 <= ls_v9;
if (!ls_v10) goto ls_end26;
ls_object_copy(&(ls_v11),ls_c1);
ls_v13 = ls_c6;
ls_fn2(ls_v11,ls_v13);
...
goto ls_test26;
ls_end26: ;
ls_object_copy(&(ls_v18),ls_c1);
ls_v20 = ls_fn3(ls_v18);
printf("%ld\n",(long)ls_v20);
...
static void ls_fn2(ls_native_object * ls_c3,int32_t ls_c4) {
ls_native_retain(ls_c3);
ls_native_object * ls_v0 = NULL;
int32_t ls_v1;
int32_t ls_v2;
int32_t ls_v3;
ls_object_copy(&(ls_v0),ls_c3);

...
typedef struct {
ls_native_object * (*code)(void *,ls_callable0);
void *environment;
uint64_t identity;
} ls_callable1;
...
static inline ls_native_object * ls_callable1_call(ls_callable1 value,ls_callable0 ls_p0) {
ls_native_retain(value.environment);
...
static inline ls_value ls_callable3_call(ls_callable3 value,ls_value ls_p0) {
ls_native_retain(value.environment);
...
static int32_t ls_fn1(int32_t ls_c7,ls_callable0 ls_c8);
static void ls_fn2(ls_native_object * ls_c10,ls_callable0 ls_c11);
static int32_t ls_fn3(ls_native_object * ls_c12,int32_t ls_c13);
static ls_value ls_fn4(ls_value ls_c15,ls_callable3 ls_c16);
static int32_t ls_fn5(void *ls_env,int32_t ls_c6);
static int32_t ls_fn6(void *ls_env,int32_t ls_c9);
static ls_value ls_fn7(void *ls_env,ls_value ls_c14);
static int32_t ls_fn8(void *ls_env,int32_t ls_c17);
static int32_t ls_fn9(void *ls_env,int32_t ls_c18);
static ls_callable0 ls_closure5(void) {
return (ls_callable0){ls_fn5,NULL,ls_native_fresh_identity()};
}
static ls_callable0 ls_closure6(void) {
return (ls_callable0){ls_fn6,NULL,ls_native_fresh_identity()};
}
static ls_callable3 ls_closure7(void) {
return (ls_callable3){ls_fn7,NULL,ls_native_fresh_identity()};
}
static ls_callable0 ls_closure8(void) {
return (ls_callable0){ls_fn8,NULL,ls_native_fresh_identity()};
}
static ls_callable0 ls_closure9(void) {
return (ls_callable0){ls_fn9,NULL,ls_native_fresh_identity()};
}
static void ls_init0(void) {
...
ls_c3 = ls_v4;
ls_ready3 = true;
ls_v6 = ls_from_u32(UINT32_C(5));
ls_v7 = ls_fn1(ls_v6,(ls_callable0){0});
printf("%ld\n",(long)ls_v7);
ls_v10 = ls_from_u32(UINT32_C(5));
ls_callable0_take(&(ls_v11),ls_closure8());
ls_v12 = ls_fn1(ls_v10,ls_v11);
printf("%ld\n",(long)ls_v12);
ls_v14 = (ls_value){0};
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_value_to_callable0(ls_v14);
ls_native_retain(((ls_object0 *)ls_o)->ls_m0.environment);
ls_object_take(&(ls_v15),(ls_native_object *)ls_o);
}
ls_fn2(ls_v15,(ls_callable0){0});
ls_object_copy(&(ls_c4),ls_v15);
ls_v18 = (ls_value){0};
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_value_to_callable0(ls_v18);
ls_native_retain(((ls_object0 *)ls_o)->ls_m0.environment);
ls_object_take(&(ls_v19),(ls_native_object *)ls_o);
}
ls_callable0_take(&(ls_v21),ls_closure9());
ls_fn2(ls_v19,ls_v21);
ls_object_copy(&(ls_c5),ls_v19);
ls_object_copy(&(ls_v23),ls_c4);
ls_v25 = ls_from_u32(UINT32_C(4));
ls_v26 = ls_fn3(ls_v23,ls_v25);
printf("%ld\n",(long)ls_v26);
ls_object_copy(&(ls_v28),ls_c5);
ls_v30 = ls_from_u32(UINT32_C(4));
ls_v31 = ls_fn3(ls_v28,ls_v30);
printf("%ld\n",(long)ls_v31);
ls_v34 = (ls_string){ls_s6,sizeof ls_s6/sizeof *ls_s6};
ls_v35 = ls_value_to_string(ls_fn4(ls_value_string(ls_v34),(ls_callable3){0}));
ls_print_string(ls_v35);
ls_object_clear(&ls_v28);
ls_object_clear(&ls_v23);
ls_object_clear(&ls_c5);
ls_callable0_clear(&ls_v21);
ls_object_clear(&ls_v19);
ls_object_clear(&ls_c4);
ls_object_clear(&ls_v15);
ls_callable0_clear(&ls_v11);
}
static int32_t ls_fn1(int32_t ls_c7,ls_callable0 ls_c8) {
ls_native_retain(ls_c8.environment);
ls_callable0 ls_v0 = {0};
bool ls_v1;
ls_callable0 ls_v2 = {0};
ls_callable0 ls_v3 = {0};
int32_t ls_v4;
int32_t ls_v5;
ls_callable0_copy(&(ls_v0),ls_c8);
ls_v1 = ls_v0.code == NULL;
if (ls_v1) {
ls_callable0_take(&(ls_v2),ls_closure5());
ls_callable0_copy(&(ls_c8),ls_v2);
ls_callable0_clear(&ls_v2);
}
ls_callable0_copy(&(ls_v3),ls_c8);
ls_v4 = ls_c7;
ls_v5 = ls_v3.code(ls_v3.environment,ls_v4);
{
int32_t ls_return = ls_v5;
ls_callable0_clear(&ls_v3);
...
ls_native_retain(ls_c11.environment);
ls_callable0 ls_v0 = {0};
bool ls_v1;
ls_callable0 ls_v2 = {0};
ls_native_object * ls_v3 = NULL;
ls_callable0 ls_v4 = {0};
ls_callable0_copy(&(ls_v0),ls_c11);
ls_v1 = ls_v0.code == NULL;
if (ls_v1) {
ls_callable0_take(&(ls_v2),ls_closure6());
ls_callable0_copy(&(ls_c11),ls_v2);
ls_callable0_clear(&ls_v2);
}
ls_object_copy(&(ls_v3),ls_c10);
ls_callable0_copy(&(ls_v4),ls_c11);
ls_callable0_copy(&(((ls_object0 *)ls_v3)->ls_m0),ls_v4);
...
int32_t ls_v1;
int32_t ls_v2;
ls_callable0 ls_pc0 = {0};
ls_object_copy(&(ls_v0),ls_c12);
ls_callable0_copy(&ls_pc0,((ls_object0 *)ls_v0)->ls_m0);
ls_v1 = ls_c13;
ls_v2 = ls_pc0.code(ls_pc0.environment,ls_v1);
ls_callable0_clear(&ls_pc0);
{
...
static ls_value ls_fn4(ls_value ls_c15,ls_callable3 ls_c16) {
ls_value_retain(ls_c15);
ls_native_retain(ls_c16.environment);
ls_callable3 ls_v0 = {0};
bool ls_v1;
ls_callable3 ls_v2 = {0};
ls_callable3 ls_v3 = {0};
ls_value ls_v4 = {0};
ls_value ls_v5 = {0};
ls_value ls_v6 = {0};
ls_value ls_v7 = {0};
ls_callable3_copy(&(ls_v0),ls_c16);
ls_v1 = ls_v0.code == NULL;
if (ls_v1) {
ls_callable3_take(&(ls_v2),ls_closure7());
ls_callable3_copy(&(ls_c16),ls_v2);
ls_callable3_clear(&ls_v2);
}
ls_callable3_copy(&(ls_v3),ls_c16);
ls_value_copy(&(ls_v4),ls_c15);
ls_value_copy(&(ls_v5),ls_v4);
ls_value_take(&(ls_v6),ls_v3.code(ls_v3.environment,ls_v5));
ls_value_copy(&(ls_v7),ls_v6);
{
ls_value ls_return = ls_v7;
ls_value_retain(ls_return);
ls_value_clear(&ls_v7);
ls_value_clear(&ls_v6);
ls_value_clear(&ls_v5);
ls_value_clear(&ls_v4);
ls_callable3_clear(&ls_v3);
ls_callable3_clear(&ls_v0);
ls_callable3_clear(&ls_c16);
ls_value_clear(&ls_c15);
return ls_return;
}
ls_value_clear(&ls_v7);
ls_value_clear(&ls_v6);

...
static const uint16_t ls_s0[] = {108,105,118,101,};
static const uint16_t ls_s1[] = {100,101,97,100,};
...
ls_v0 = true;
if (ls_v0) {
ls_v1 = (ls_string){ls_s0,sizeof ls_s0/sizeof *ls_s0};
ls_print_string(ls_v1);
} else {
ls_v3 = (ls_string){ls_s1,sizeof ls_s1/sizeof *ls_s1};
ls_print_string(ls_v3);
}
ls_v5 = false;
if (ls_v5) {
...
ls_v9 = ls_from_u32(UINT32_C(1));
ls_v10 = ls_from_u32((uint32_t)((uint32_t)ls_v8 + (uint32_t)ls_v9));
ls_v11 = ls_from_u32(UINT32_C(2));
ls_v12 = ls_v10 == ls_v11;
if (ls_v12) {

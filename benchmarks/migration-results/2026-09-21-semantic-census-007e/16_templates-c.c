...
static const uint16_t ls_s0[] = {76,105,108,};
static const uint16_t ls_s1[] = {83,99,114,105,112,116,};
static const uint16_t ls_s2[] = {58,};
...
ls_v2 = ls_string_concat(ls_v0,ls_v1);
ls_c0 = ls_v2;
...
ls_c2 = ls_v4;
ls_v5 = ls_c0;
ls_v6 = (ls_string){ls_s2,sizeof ls_s2/sizeof *ls_s2};
ls_v7 = ls_c1;
ls_v8 = (ls_string){ls_s2,sizeof ls_s2/sizeof *ls_s2};
ls_v9 = ls_c2;
ls_v10 = ls_string_concat(ls_string_concat(ls_string_concat(ls_string_concat(ls_v5,ls_v6),ls_int_to_string(ls_v7)),ls_v8),ls_bool_to_string(ls_v9));

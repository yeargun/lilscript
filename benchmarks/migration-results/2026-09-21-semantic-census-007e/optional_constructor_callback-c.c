...
typedef struct {
ls_native_object * (*code)(void *,ls_value,ls_callable0);
void *environment;
uint64_t identity;
} ls_callable1;
...
static inline ls_native_object * ls_callable1_call(ls_callable1 value,ls_value ls_p0,ls_callable0 ls_p1) {
ls_native_retain(value.environment);
...
ls_callable0_clear(&object->ls_m1);
}
static void ls_object0_destroy(ls_native_object *owner) { ls_object0_clear_fields((ls_object0 *)owner); }
static void ls_init0(void);
static void ls_fn1(ls_native_object * ls_c5,ls_value ls_c6,ls_callable0 ls_c7);
static bool ls_fn2(ls_native_object * ls_c8,ls_value ls_c9);
static ls_native_object * ls_fn3(ls_value ls_c11,ls_value ls_c12);
static bool ls_fn4(int32_t ls_c15,int32_t ls_c16);
static bool ls_fn5(void *ls_env,ls_value ls_c13,ls_value ls_c14);
static bool ls_adapter4(void *environment,int32_t ls_p0,int32_t ls_p1) {
(void)environment;
return ls_fn4(ls_p0,ls_p1);
}
static ls_callable0 ls_closure5(void) {
return (ls_callable0){ls_fn5,NULL,ls_native_fresh_identity()};
}
static void ls_init0(void) {
...
ls_value_take(&(ls_v6),(ls_value){0});
{
ls_value ls_adapted1 = ls_adapt_value3_0(ls_v6);
ls_object_take(&(ls_v7),ls_fn3(ls_value_int(ls_v5),ls_adapted1));
ls_value_clear(&ls_adapted1);
}
ls_object_copy(&(ls_c3),ls_v7);
ls_v9 = ls_from_u32(UINT32_C(4));
{
ls_callable0 ls_adapted1 = ls_adapt3_0((ls_callable3){ls_adapter4,NULL,UINT64_C(5)});
ls_object_take(&(ls_v11),ls_fn3(ls_value_int(ls_v9),ls_value_callable0(ls_adapted1)));
ls_callable0_clear(&ls_adapted1);
}
ls_object_copy(&(ls_c4),ls_v11);
ls_object_copy(&(ls_v12),ls_c3);
ls_v14 = ls_from_u32(UINT32_C(4));
ls_v15 = ls_fn2(ls_v12,ls_value_int(ls_v14));
puts(ls_v15 ? "true" : "false");
ls_object_copy(&(ls_v17),ls_c3);
ls_v19 = ls_from_u32(UINT32_C(6));
ls_v20 = ls_fn2(ls_v17,ls_value_int(ls_v19));
puts(ls_v20 ? "true" : "false");
ls_object_copy(&(ls_v22),ls_c4);
ls_v24 = ls_from_u32(UINT32_C(6));
ls_v25 = ls_fn2(ls_v22,ls_value_int(ls_v24));
puts(ls_v25 ? "true" : "false");
ls_object_copy(&(ls_v27),ls_c4);
ls_v29 = ls_from_u32(UINT32_C(5));
ls_v30 = ls_fn2(ls_v27,ls_value_int(ls_v29));
...
ls_value_retain(ls_c6);
ls_native_retain(ls_c7.environment);
ls_native_object * ls_v0 = NULL;
ls_value ls_v1 = {0};
ls_value ls_v2 = {0};
ls_native_object * ls_v3 = NULL;
ls_callable0 ls_v4 = {0};
ls_object_copy(&(ls_v0),ls_c5);
ls_value_copy(&(ls_v1),ls_c6);
ls_value_copy(&(ls_v2),ls_v1);
ls_value_copy(&(((ls_object0 *)ls_v0)->ls_m0),ls_v2);
ls_object_copy(&(ls_v3),ls_c5);
ls_callable0_copy(&(ls_v4),ls_c7);
ls_callable0_copy(&(((ls_object0 *)ls_v3)->ls_m1),ls_v4);
...
ls_value_clear(&ls_c6);
ls_object_clear(&ls_c5);
}
static bool ls_fn2(ls_native_object * ls_c8,ls_value ls_c9) {
ls_native_retain(ls_c8);
ls_value_retain(ls_c9);
ls_callable0 ls_c10 = {0};
ls_native_object * ls_v0 = NULL;
ls_callable0 ls_v1 = {0};
ls_callable0 ls_v2 = {0};
ls_native_object * ls_v3 = NULL;
ls_value ls_v4 = {0};
ls_value ls_v5 = {0};
ls_value ls_v6 = {0};
...
ls_callable0_copy(&(ls_v1),((ls_object0 *)ls_v0)->ls_m1);
ls_callable0_copy(&(ls_c10),ls_v1);
ls_callable0_copy(&(ls_v2),ls_c10);
ls_object_copy(&(ls_v3),ls_c8);
ls_value_copy(&(ls_v4),((ls_object0 *)ls_v3)->ls_m0);
ls_value_copy(&(ls_v5),ls_v4);
ls_value_copy(&(ls_v6),ls_c9);
ls_value_copy(&(ls_v7),ls_v6);
ls_v8 = ls_v2.code(ls_v2.environment,ls_v5,ls_v7);
{
bool ls_return = ls_v8;
ls_value_clear(&ls_v7);
ls_value_clear(&ls_v6);
ls_value_clear(&ls_v5);
ls_value_clear(&ls_v4);
ls_object_clear(&ls_v3);
ls_callable0_clear(&ls_v2);
ls_callable0_clear(&ls_c10);
ls_callable0_clear(&ls_v1);
ls_object_clear(&ls_v0);
ls_value_clear(&ls_c9);
...
ls_value ls_v10 = {0};
ls_value ls_v11 = {0};
ls_callable0 ls_v12 = {0};
ls_value ls_v14 = {0};
ls_value ls_v15 = {0};
ls_native_object * ls_v16 = NULL;
ls_value ls_v18 = {0};
ls_value ls_v19 = {0};
ls_callable0 ls_v20 = {0};
ls_value_copy(&(ls_v0),ls_c12);
ls_v1 = false;
if (ls_v1) {
ls_value_take(&(ls_v2),(ls_value){0});
ls_value_copy(&(ls_c12),ls_v2);
ls_value_clear(&ls_v2);
}
ls_value_copy(&(ls_v3),ls_c12);
ls_v4 = (ls_value){0};
...
((ls_object0 *)ls_o)->ls_m0 = ls_v6;
ls_value_retain(((ls_object0 *)ls_o)->ls_m0);
((ls_object0 *)ls_o)->ls_m1 = ls_value_to_callable0(ls_v7);
ls_native_retain(((ls_object0 *)ls_o)->ls_m1.environment);
ls_object_take(&(ls_v8),(ls_native_object *)ls_o);
}
ls_value_copy(&(ls_v10),ls_c11);
ls_value_copy(&(ls_v11),ls_v10);
ls_callable0_take(&(ls_v12),ls_closure5());
ls_fn1(ls_v8,ls_v11,ls_v12);
{
ls_native_object * ls_return = ls_v8;
ls_native_retain(ls_return);
ls_callable0_clear(&ls_v12);
ls_value_clear(&ls_v11);
ls_value_clear(&ls_v10);
ls_object_clear(&ls_v8);
ls_callable0_clear(&ls_v20);
ls_value_clear(&ls_v19);
ls_value_clear(&ls_v18);
ls_object_clear(&ls_v16);
ls_value_clear(&ls_v3);
ls_value_clear(&ls_v0);
ls_value_clear(&ls_c12);
...
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v14;
ls_value_retain(((ls_object0 *)ls_o)->ls_m0);
((ls_object0 *)ls_o)->ls_m1 = ls_value_to_callable0(ls_v15);
ls_native_retain(((ls_object0 *)ls_o)->ls_m1.environment);
ls_object_take(&(ls_v16),(ls_native_object *)ls_o);
}
ls_value_copy(&(ls_v18),ls_c11);
ls_value_copy(&(ls_v19),ls_v18);
ls_callable0_copy(&(ls_v20),ls_value_to_callable0(ls_c12));
ls_fn1(ls_v16,ls_v19,ls_v20);
{
ls_native_object * ls_return = ls_v16;
ls_native_retain(ls_return);
ls_callable0_clear(&ls_v20);
ls_value_clear(&ls_v19);
ls_value_clear(&ls_v18);
...
ls_native_identity_counter = UINT64_C(6);
ls_init0();
fflush(stdout);
ls_strings_release();
return 0;

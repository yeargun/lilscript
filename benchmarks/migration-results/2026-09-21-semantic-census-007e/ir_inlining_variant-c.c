...
static inline int32_t ls_shl(int32_t value, int32_t count) {
...
static int32_t ls_fn1(int32_t ls_c2);
static void ls_init0(void) {
...
ls_v7 = ls_from_u32(UINT32_C(7));
ls_v8 = ls_from_u32(UINT32_C(8));
ls_array0_take(&(ls_v9),ls_array0_new(8));
ls_array0_push(ls_v9,ls_v1);
ls_array0_push(ls_v9,ls_v2);
ls_array0_push(ls_v9,ls_v3);
ls_array0_push(ls_v9,ls_v4);
ls_array0_push(ls_v9,ls_v5);
ls_array0_push(ls_v9,ls_v6);
ls_array0_push(ls_v9,ls_v7);
ls_array0_push(ls_v9,ls_v8);
ls_array0_copy(&(ls_c1),ls_v9);
ls_array0_copy(&(ls_v11),ls_c1);
ls_v12 = ls_from_u32(UINT32_C(0));
ls_v13 = ls_array0_get(ls_v11,ls_v12);
ls_v14 = ls_fn1(ls_v13);
printf("%ld\n",(long)ls_v14);
ls_array0_copy(&(ls_v17),ls_c1);
ls_v18 = ls_from_u32(UINT32_C(1));
ls_v19 = ls_array0_get(ls_v17,ls_v18);
ls_v20 = ls_fn1(ls_v19);
printf("%ld\n",(long)ls_v20);
ls_array0_copy(&(ls_v23),ls_c1);
ls_v24 = ls_from_u32(UINT32_C(2));
ls_v25 = ls_array0_get(ls_v23,ls_v24);
ls_v26 = ls_fn1(ls_v25);
printf("%ld\n",(long)ls_v26);
ls_array0_copy(&(ls_v29),ls_c1);
ls_v30 = ls_from_u32(UINT32_C(3));
ls_v31 = ls_array0_get(ls_v29,ls_v30);
ls_v32 = ls_fn1(ls_v31);
printf("%ld\n",(long)ls_v32);
ls_array0_copy(&(ls_v35),ls_c1);
ls_v36 = ls_from_u32(UINT32_C(4));
ls_v37 = ls_array0_get(ls_v35,ls_v36);
ls_v38 = ls_fn1(ls_v37);
printf("%ld\n",(long)ls_v38);
ls_array0_copy(&(ls_v41),ls_c1);
ls_v42 = ls_from_u32(UINT32_C(5));
ls_v43 = ls_array0_get(ls_v41,ls_v42);
ls_v44 = ls_fn1(ls_v43);
printf("%ld\n",(long)ls_v44);
ls_array0_copy(&(ls_v47),ls_c1);
ls_v48 = ls_from_u32(UINT32_C(6));
ls_v49 = ls_array0_get(ls_v47,ls_v48);
ls_v50 = ls_fn1(ls_v49);
printf("%ld\n",(long)ls_v50);
ls_array0_copy(&(ls_v53),ls_c1);
ls_v54 = ls_from_u32(UINT32_C(7));
ls_v55 = ls_array0_get(ls_v53,ls_v54);
ls_v56 = ls_fn1(ls_v55);
printf("%ld\n",(long)ls_v56);
ls_array0_clear(&ls_v53);
ls_array0_clear(&ls_v47);
...
ls_v1 = ls_c2;
ls_v2 = ls_c2;
ls_v3 = ls_shl(ls_v1,ls_v2);
ls_v4 = ls_from_u32((uint32_t)ls_v0 ^ (uint32_t)ls_v3);
{

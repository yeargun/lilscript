...
static inline int32_t ls_ushr(int32_t value, int32_t count) {
...
ls_v3 = ls_from_u32(UINT32_C(31));
ls_v4 = ls_shl(ls_v2,ls_v3);
ls_c1 = ls_v4;
ls_v5 = ls_c1;
printf("%ld\n",(long)ls_v5);
ls_v7 = ls_c1;
ls_v8 = ls_from_u32(UINT32_C(31));
ls_v9 = ls_shr(ls_v7,ls_v8);
printf("%ld\n",(long)ls_v9);
ls_v11 = ls_c0;
ls_v12 = ls_from_u32(UINT32_C(1));
ls_v13 = ls_ushr(ls_v11,ls_v12);
printf("%ld\n",(long)ls_v13);
ls_v15 = ls_c1;
ls_v16 = ls_from_u32(UINT32_C(31));
ls_v17 = ls_ushr(ls_v15,ls_v16);
printf("%ld\n",(long)ls_v17);
ls_v19 = ls_from_u32(UINT32_C(1));
ls_v20 = ls_from_u32(UINT32_C(33));
ls_v21 = ls_shl(ls_v19,ls_v20);
printf("%ld\n",(long)ls_v21);
ls_v23 = ls_from_u32(UINT32_C(305419896));
ls_v24 = ls_from_u32(UINT32_C(16711935));
ls_v25 = ls_from_u32((uint32_t)ls_v23 & (uint32_t)ls_v24);
printf("%ld\n",(long)ls_v25);
ls_v27 = ls_from_u32(UINT32_C(301989888));
ls_v28 = ls_from_u32(UINT32_C(3407872));
ls_v29 = ls_from_u32((uint32_t)ls_v27 | (uint32_t)ls_v28);
printf("%ld\n",(long)ls_v29);
ls_v31 = ls_from_u32(UINT32_C(1437226410));
ls_v32 = ls_from_u32(UINT32_C(252645135));
ls_v33 = ls_from_u32((uint32_t)ls_v31 ^ (uint32_t)ls_v32);
printf("%ld\n",(long)ls_v33);
ls_v35 = ls_from_u32(UINT32_C(1431655766));
ls_v36 = ls_from_u32((uint32_t)(UINT32_C(0) - (uint32_t)ls_v35));
ls_c2 = ls_v36;
ls_v37 = ls_c2;
ls_v38 = ls_from_u32(UINT32_C(268435455));
ls_v39 = ls_from_u32((uint32_t)ls_v37 & (uint32_t)ls_v38);
ls_c2 = ls_v39;
ls_v40 = ls_c2;
ls_v41 = ls_from_u32(UINT32_C(268435456));
ls_v42 = ls_from_u32((uint32_t)ls_v40 | (uint32_t)ls_v41);
ls_c2 = ls_v42;
ls_v43 = ls_c2;
ls_v44 = ls_from_u32(UINT32_C(16711935));
ls_v45 = ls_from_u32((uint32_t)ls_v43 ^ (uint32_t)ls_v44);
ls_c2 = ls_v45;
ls_v46 = ls_c2;
ls_v47 = ls_from_u32(UINT32_C(4));
ls_v48 = ls_shl(ls_v46,ls_v47);
ls_c2 = ls_v48;
ls_v49 = ls_c2;
ls_v50 = ls_from_u32(UINT32_C(2));
ls_v51 = ls_shr(ls_v49,ls_v50);
ls_c2 = ls_v51;
ls_v52 = ls_c2;
ls_v53 = ls_from_u32(UINT32_C(1));
ls_v54 = ls_ushr(ls_v52,ls_v53);
ls_c2 = ls_v54;
ls_v55 = ls_c2;
printf("%ld\n",(long)ls_v55);
ls_v57 = ls_c0;
ls_v58 = ls_from_u32(UINT32_C(16));
ls_v59 = ls_int_to_radix(ls_v57,ls_v58);
ls_print_string(ls_v59);
ls_v61 = ls_c0;
ls_v62 = ls_from_u32(UINT32_C(16));
ls_v63 = ls_uint_to_radix((uint32_t)ls_v61,false,ls_v62);
ls_print_string(ls_v63);
ls_v65 = ls_c1;
ls_v66 = ls_from_u32(UINT32_C(2));
ls_v67 = ls_uint_to_radix((uint32_t)ls_v65,false,ls_v66);
ls_print_string(ls_v67);
ls_v69 = ls_from_u32(UINT32_C(35));
ls_v70 = ls_from_u32(UINT32_C(36));
ls_v71 = ls_int_to_radix(ls_v69,ls_v70);
ls_print_string(ls_v71);
}
int main(void) {

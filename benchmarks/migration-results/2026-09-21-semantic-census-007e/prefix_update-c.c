...
static void ls_fn1(ls_native_object * ls_c4,int32_t ls_c5);
static void ls_init0(void) {
int32_t ls_c1;
...
ls_v18 = ls_c1;
printf("%ld\n",(long)ls_v18);
ls_v20 = ls_from_u32(UINT32_C(4));
ls_array0_take(&(ls_v21),ls_array0_new(1));
ls_array0_push(ls_v21,ls_v20);
ls_array0_copy(&(ls_c2),ls_v21);
ls_array0_copy(&(ls_v22),ls_c2);
ls_v23 = ls_from_u32(UINT32_C(0));
ls_v24 = ls_array0_get(ls_v22,ls_v23);
ls_v25 = ls_from_u32(UINT32_C(1));
ls_v26 = ls_from_u32((uint32_t)((uint32_t)ls_v24 + (uint32_t)ls_v25));
ls_array0_set(ls_v22,ls_v23,ls_v26);
printf("%ld\n",(long)ls_v26);
ls_array0_copy(&(ls_v28),ls_c2);
ls_v29 = ls_from_u32(UINT32_C(0));
ls_v30 = ls_array0_get(ls_v28,ls_v29);
ls_v31 = ls_from_u32(UINT32_C(1));
ls_v32 = ls_from_u32((uint32_t)((uint32_t)ls_v30 - (uint32_t)ls_v31));
ls_array0_set(ls_v28,ls_v29,ls_v32);
printf("%ld\n",(long)ls_v30);
ls_array0_copy(&(ls_v34),ls_c2);
ls_v35 = ls_from_u32(UINT32_C(0));
ls_v36 = ls_array0_get(ls_v34,ls_v35);
printf("%ld\n",(long)ls_v36);
ls_v38 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v38;
ls_object_take(&(ls_v39),(ls_native_object *)ls_o);
}
ls_v41 = ls_from_u32(UINT32_C(7));
ls_fn1(ls_v39,ls_v41);
ls_object_copy(&(ls_c3),ls_v39);
ls_object_copy(&(ls_v43),ls_c3);
ls_v44 = ((ls_object0 *)ls_v43)->ls_m0;
ls_v45 = ls_from_u32(UINT32_C(1));
ls_v46 = ls_from_u32((uint32_t)((uint32_t)ls_v44 - (uint32_t)ls_v45));
((ls_object0 *)ls_v43)->ls_m0 = ls_v46;
printf("%ld\n",(long)ls_v46);
ls_object_copy(&(ls_v48),ls_c3);
ls_v49 = ((ls_object0 *)ls_v48)->ls_m0;
ls_v50 = ls_from_u32(UINT32_C(1));
ls_v51 = ls_from_u32((uint32_t)((uint32_t)ls_v49 + (uint32_t)ls_v50));
((ls_object0 *)ls_v48)->ls_m0 = ls_v51;
printf("%ld\n",(long)ls_v49);
ls_object_copy(&(ls_v53),ls_c3);
ls_v54 = ((ls_object0 *)ls_v53)->ls_m0;
printf("%ld\n",(long)ls_v54);

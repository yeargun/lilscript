...
static const uint16_t ls_s3[] = {108,105,108,};
static const uint16_t ls_s4[] = {115,99,114,105,112,116,};
static void ls_init0(void);
static bool ls_fn1(ls_value ls_c3,ls_value ls_c4);
static void ls_fn2(ls_native_object * ls_c5,int32_t ls_c6);
static void ls_init0(void) {
...
ls_v10 = ls_fn1(ls_value_int(ls_v8),ls_value_int(ls_v9));
puts(ls_v10 ? "true" : "false");
ls_v13 = ls_from_u32(UINT32_C(7));
ls_v14 = ls_from_u32(UINT32_C(8));
ls_v15 = ls_fn1(ls_value_int(ls_v13),ls_value_int(ls_v14));
puts(ls_v15 ? "true" : "false");
ls_v18 = ls_f64_bits(UINT64_C(0));
ls_v19 = ls_f64_bits(UINT64_C(0));
ls_v20 = ls_f64(-(double)ls_v19);
ls_v21 = ls_fn1(ls_value_float(ls_v18),ls_value_float(ls_v20));
puts(ls_v21 ? "true" : "false");
ls_v24 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_v25 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_v26 = ls_fn1(ls_value_string(ls_v24),ls_value_string(ls_v25));
puts(ls_v26 ? "true" : "false");
ls_v29 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_v30 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v31 = ls_fn1(ls_value_string(ls_v29),ls_value_string(ls_v30));
puts(ls_v31 ? "true" : "false");
ls_object_copy(&(ls_v34),ls_c2);
ls_object_copy(&(ls_v35),ls_c2);
ls_v36 = ls_fn1(ls_value_object(ls_v34),ls_value_object(ls_v35));
puts(ls_v36 ? "true" : "false");
ls_object_copy(&(ls_v39),ls_c2);
...
ls_v43 = ls_from_u32(UINT32_C(1));
ls_fn2(ls_v41,ls_v43);
ls_v45 = ls_fn1(ls_value_object(ls_v39),ls_value_object(ls_v41));

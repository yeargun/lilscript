...
static void ls_init1(void);
static int32_t ls_fn2(ls_t0 ls_c3,int32_t ls_c4);
static void ls_fn3(ls_t0 *ls_c5,int32_t *ls_c6,int32_t ls_c7);
static int32_t ls_fn4(int32_t ls_c8,int32_t ls_c9);
static void ls_init0(void) {
int32_t ls_v1;
int32_t ls_v2;
int32_t ls_v3;
ls_v1 = ls_from_u32(UINT32_C(32));
ls_v2 = ls_from_u32(UINT32_C(14));
ls_v3 = ls_fn4(ls_v1,ls_v2);
printf("%ld\n",(long)ls_v3);
}
static void ls_init1(void) {
}
...
ls_v10 = ls_fn2(ls_v8,ls_v9);
ls_c12 = ls_v10;
ls_v11 = ls_c8;
ls_v12 = ls_c9;
ls_v13 = (ls_t0){ls_v11,ls_v12};
ls_v14 = ls_v13;
ls_c13 = ls_v14;
ls_v15 = ls_c13;
ls_v16 = ls_v15;
ls_c14 = ls_v16;
ls_a1_0 = &(ls_c13);
ls_a1_1 = &(ls_c13.ls_f0);
ls_v18 = ls_from_u32(UINT32_C(4));
ls_fn3(ls_a1_0,ls_a1_1,ls_v18);
ls_v20 = ls_c12;
printf("%ld\n",(long)ls_v20);
ls_v22 = ls_c11.ls_f0;
printf("%ld\n",(long)ls_v22);

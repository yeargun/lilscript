...
static int32_t ls_fn1(int32_t ls_c3);
static int32_t ls_fn2(int32_t ls_c4,int32_t ls_c5);
static int32_t ls_fn3(int32_t ls_c7);
static void ls_init0(void) {
int32_t ls_v4;
int32_t ls_v5;
int32_t ls_v8;
...
ls_v5 = ls_fn1(ls_v4);
printf("%ld\n",(long)ls_v5);
ls_v8 = ls_from_u32(UINT32_C(1071));
ls_v9 = ls_from_u32(UINT32_C(462));
ls_v10 = ls_fn2(ls_v8,ls_v9);
printf("%ld\n",(long)ls_v10);
ls_v13 = ls_from_u32(UINT32_C(12));
ls_v14 = ls_fn3(ls_v13);
printf("%ld\n",(long)ls_v14);
}
static int32_t ls_fn1(int32_t ls_c3) {
int32_t ls_v0;

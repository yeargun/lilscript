...
static const uint16_t ls_s0[] = {76,105,108,83,99,114,105,112,116,};
...
ls_c0 = ls_v0;
ls_v1 = ls_c0;
ls_v2 = ls_string_case(ls_v1,true);
ls_print_string(ls_v2);
ls_v4 = ls_c0;
ls_v5 = ls_string_case(ls_v4,false);
ls_print_string(ls_v5);
}
int main(void) {

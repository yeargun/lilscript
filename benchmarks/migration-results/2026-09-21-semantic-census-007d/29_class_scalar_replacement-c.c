...
#endif
typedef struct {
ls_native_object * (*code)(void *,double,double);
void *environment;
uint64_t identity;
} ls_callable0;
...
static inline ls_native_object * ls_callable0_call(ls_callable0 value,double ls_p0,double ls_p1) {
ls_native_retain(value.environment);
...
static void ls_fn1(ls_native_object * ls_c2,double ls_c3,double ls_c4);
static double ls_fn2(ls_native_object * ls_c5);
static void ls_init0(void) {
...
ls_v6 = ls_f64_bits(UINT64_C(4613937818241073152));
ls_v7 = ls_f64_bits(UINT64_C(4616189618054758400));
ls_fn1(ls_v4,ls_v6,ls_v7);
ls_object_copy(&(ls_c1),ls_v4);
ls_object_copy(&(ls_v9),ls_c1);
ls_v11 = ls_f64(ls_fn2(ls_v9));
ls_print_number(ls_v11);
...
ls_object_copy(&(ls_v2),ls_c2);
ls_v3 = ls_c4;
((ls_object0 *)ls_v2)->ls_m1 = ls_v3;
...
ls_object_copy(&(ls_v2),ls_c5);
ls_v3 = ((ls_object0 *)ls_v2)->ls_m0;
ls_v4 = ls_f64((double)ls_v1 * (double)ls_v3);
ls_object_copy(&(ls_v5),ls_c5);
ls_v6 = ((ls_object0 *)ls_v5)->ls_m1;
ls_object_copy(&(ls_v7),ls_c5);
ls_v8 = ((ls_object0 *)ls_v7)->ls_m1;
ls_v9 = ls_f64((double)ls_v6 * (double)ls_v8);
ls_v10 = ls_f64((double)ls_v4 + (double)ls_v9);
{
double ls_return = ls_v10;

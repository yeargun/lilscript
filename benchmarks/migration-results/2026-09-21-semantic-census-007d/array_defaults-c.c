...
typedef struct {
ls_native_object * (*code)(void *,ls_array0 *);
void *environment;
uint64_t identity;
} ls_callable0;
...
static inline ls_native_object * ls_callable0_call(ls_callable0 value,ls_array0 * ls_p0) {
ls_native_retain(value.environment);
...
struct ls_array1 { ls_native_object owner; size_t length; size_t capacity; ls_array0 * *items; };
static void ls_array1_acquire(ls_array0 * value) { (void)value; ls_native_retain(value);
}
static void ls_array1_drop(ls_array0 * value) { (void)value; ls_native_release(value);
}
static void ls_array1_destroy(ls_native_object *owner) {
ls_array1 *array = (ls_array1 *)owner;
for (size_t index = 0; index < array->length; index++) ls_array1_drop(array->items[index]);
free(array->items);
}
static ls_array1 *ls_array1_new(size_t capacity) {
ls_array1 *array = ls_native_allocate(sizeof *array, ls_array1_destroy);
array->length = 0; array->capacity = 0; array->items = NULL;
if (capacity) {
if (capacity > SIZE_MAX / sizeof *array->items) ls_native_resource_failure();
array->items = malloc(capacity * sizeof *array->items);
...
static void ls_array1_reserve(ls_array1 *array, size_t length) {
if (length <= array->capacity) return;
size_t capacity = array->capacity ? array->capacity : 4;
while (capacity < length) { if (capacity > SIZE_MAX / 2 / sizeof *array->items) ls_native_resource_failure(); capacity *= 2; }
...
static int32_t ls_array1_push_owned(ls_array1 *array, ls_array0 * value) {
if (array->length >= (size_t)INT32_MAX) ls_native_resource_failure();
ls_array1_reserve(array, array->length + 1);
array->items[array->length++] = value;
return (int32_t)array->length;
}
static int32_t ls_array1_push(ls_array1 *array, ls_array0 * value) {
ls_array1_acquire(value);
return ls_array1_push_owned(array, value);
}
static void ls_array1_hole(ls_array1 *array) { (void)array; ls_native_undefined_element(); }
static ls_array0 * ls_array1_get(ls_array1 *array, int32_t index) {
if (index < 0 || (size_t)index >= array->length) { ls_native_undefined_element(); return array->items[0]; }
return array->items[index];
}
static void ls_array1_set(ls_array1 *array, int32_t index, ls_array0 * value) {
...
static ls_array0 * ls_array1_pop(ls_array1 *array) {
if (!array->length) { ls_native_undefined_element(); return array->items[0]; }
return array->items[--array->length];
}
static ls_array1 *ls_array1_slice(ls_array1 *array, size_t start, size_t end) {
...
static ls_array1 *ls_array1_concat(ls_array1 *left, ls_array1 *right) {
size_t left_length = left->length, right_length = right->length;
...
static ls_array1 *ls_array1_reverse(ls_array1 *array) {
...
static ls_array1 *ls_array1_fill(ls_array1 *array, ls_array0 * value) {
...
static ls_array1 *ls_array1_splice(ls_array1 *array, int32_t start, int32_t count) {
size_t from = ls_array_relative(start, array->length);
size_t removed = count <= 0 ? 0 : (size_t)count;
if (removed > array->length - from) removed = array->length - from;
...
static ls_array1 *ls_array1_copy_within(ls_array1 *array, int32_t target, int32_t start, bool bounded, int32_t end) {
size_t length = array->length;
size_t to = ls_array_relative(target, length), from = ls_array_relative(start, length);
size_t final = bounded ? ls_array_relative(end, length) : length;
if (final > from) {
...
static void ls_array1_copy(ls_array1 **slot, ls_array1 *value) { ls_native_retain(value); ls_native_release(*slot); *slot = value; }
static void ls_array1_take(ls_array1 **slot, ls_array1 *value) { ls_native_release(*slot); *slot = value; }
static void ls_array1_clear(ls_array1 **slot) { ls_native_release(*slot); *slot = NULL; }
static int32_t ls_array1_index_of(ls_array1 *array, ls_array0 * right) {
for (size_t index = 0; index < array->length; index++) { ls_array0 * left = array->items[index]; if (left == right) return (int32_t)index; }
return -1;
}
static bool ls_array1_includes(ls_array1 *array, ls_array0 * right, int32_t start) {
size_t length = array->length;
size_t from = start >= 0 ? (size_t)start : ls_array_relative(start, length);
...
static int32_t ls_fn1(ls_array0 * ls_c5);
static int32_t ls_fn2(ls_array1 * ls_c8);
static void ls_fn3(ls_native_object * ls_c9,ls_array0 * ls_c10);
static int32_t ls_fn4(ls_native_object * ls_c11);
static void ls_init0(void) {
...
int32_t ls_v12;
int32_t ls_v13;
ls_array0 * ls_v14 = NULL;
int32_t ls_v15;
int32_t ls_v18;
ls_array0 * ls_v19 = NULL;
int32_t ls_v20;
int32_t ls_v21;
ls_array0 * ls_v22 = NULL;
ls_array1 * ls_v23 = NULL;
int32_t ls_v24;
ls_array0 * ls_v26 = NULL;
ls_native_object * ls_v27 = NULL;
ls_array0 * ls_v29 = NULL;
ls_array0 * ls_v31 = NULL;
ls_native_object * ls_v32 = NULL;
ls_array0 * ls_v34 = NULL;
ls_native_object * ls_v36 = NULL;
ls_array0 * ls_v37 = NULL;
int32_t ls_v38;
int32_t ls_v39;
ls_native_object * ls_v40 = NULL;
int32_t ls_v42;
ls_native_object * ls_v44 = NULL;
int32_t ls_v46;
ls_v5 = ls_from_u32(UINT32_C(1));
ls_v6 = ls_from_u32(UINT32_C(2));
ls_v7 = ls_from_u32(UINT32_C(3));
ls_array0_take(&(ls_v8),ls_array0_new(3));
ls_array0_push(ls_v8,ls_v5);
ls_array0_push(ls_v8,ls_v6);
ls_array0_push(ls_v8,ls_v7);
ls_v9 = ls_fn1(ls_v8);
printf("%ld\n",(long)ls_v9);
ls_v12 = ls_from_u32(UINT32_C(4));
ls_v13 = ls_from_u32(UINT32_C(5));
ls_array0_take(&(ls_v14),ls_array0_new(2));
ls_array0_push(ls_v14,ls_v12);
ls_array0_push(ls_v14,ls_v13);
ls_v15 = ls_fn1(ls_v14);
printf("%ld\n",(long)ls_v15);
ls_v18 = ls_from_u32(UINT32_C(1));
ls_array0_take(&(ls_v19),ls_array0_new(1));
ls_array0_push(ls_v19,ls_v18);
ls_v20 = ls_from_u32(UINT32_C(2));
ls_v21 = ls_from_u32(UINT32_C(3));
ls_array0_take(&(ls_v22),ls_array0_new(2));
ls_array0_push(ls_v22,ls_v20);
ls_array0_push(ls_v22,ls_v21);
ls_array1_take(&(ls_v23),ls_array1_new(2));
ls_array1_push(ls_v23,ls_v19);
ls_array1_push(ls_v23,ls_v22);
ls_v24 = ls_fn2(ls_v23);
printf("%ld\n",(long)ls_v24);
ls_array0_take(&(ls_v26),ls_array0_new(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v26;
ls_native_retain(((ls_object0 *)ls_o)->ls_m0);
ls_object_take(&(ls_v27),(ls_native_object *)ls_o);
}
ls_array0_take(&(ls_v29),ls_array0_new(0));
ls_fn3(ls_v27,ls_v29);
ls_object_copy(&(ls_c3),ls_v27);
ls_array0_take(&(ls_v31),ls_array0_new(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v31;
ls_native_retain(((ls_object0 *)ls_o)->ls_m0);
ls_object_take(&(ls_v32),(ls_native_object *)ls_o);
}
ls_array0_take(&(ls_v34),ls_array0_new(0));
ls_fn3(ls_v32,ls_v34);
ls_object_copy(&(ls_c4),ls_v32);
ls_object_copy(&(ls_v36),ls_c3);
ls_array0_copy(&(ls_v37),((ls_object0 *)ls_v36)->ls_m0);
ls_v38 = ls_from_u32(UINT32_C(9));
ls_v39 = ls_array0_push(ls_v37,ls_v38);
ls_object_copy(&(ls_v40),ls_c3);
ls_v42 = ls_fn4(ls_v40);
printf("%ld\n",(long)ls_v42);
ls_object_copy(&(ls_v44),ls_c4);
ls_v46 = ls_fn4(ls_v44);
printf("%ld\n",(long)ls_v46);
ls_object_clear(&ls_v44);
ls_object_clear(&ls_v40);
ls_array0_clear(&ls_v37);
ls_object_clear(&ls_v36);
ls_object_clear(&ls_c4);
ls_array0_clear(&ls_v34);
ls_object_clear(&ls_v32);
ls_array0_clear(&ls_v31);
ls_object_clear(&ls_c3);
ls_array0_clear(&ls_v29);
ls_object_clear(&ls_v27);
ls_array0_clear(&ls_v26);
ls_array1_clear(&ls_v23);
ls_array0_clear(&ls_v22);
ls_array0_clear(&ls_v19);
ls_array0_clear(&ls_v14);
ls_array0_clear(&ls_v8);
}
static int32_t ls_fn1(ls_array0 * ls_c5) {
ls_native_retain(ls_c5);
int32_t ls_c6;
int32_t ls_c7;
...
int32_t ls_v7;
int32_t ls_v8;
ls_array0 * ls_v9 = NULL;
int32_t ls_v10;
bool ls_v11;
int32_t ls_v12;
ls_array0 * ls_v13 = NULL;
int32_t ls_v14;
int32_t ls_v15;
int32_t ls_v16;
int32_t ls_v17;
...
int32_t ls_v19;
int32_t ls_v20;
ls_array0_copy(&(ls_v0),ls_c5);
ls_v1 = false;
if (ls_v1) {
ls_v2 = ls_from_u32(UINT32_C(1));
ls_v3 = ls_from_u32(UINT32_C(2));
ls_v4 = ls_from_u32(UINT32_C(3));
ls_array0_take(&(ls_v5),ls_array0_new(3));
ls_array0_push(ls_v5,ls_v2);
ls_array0_push(ls_v5,ls_v3);
ls_array0_push(ls_v5,ls_v4);
ls_array0_copy(&(ls_c5),ls_v5);
...
ls_test26: ;
ls_v8 = ls_c7;
ls_array0_copy(&(ls_v9),ls_c5);
ls_v10 = (int32_t)ls_v9->length;
ls_v11 = ls_v8 < ls_v10;
ls_array0_clear(&ls_v9);
if (!ls_v11) goto ls_end26;
ls_v12 = ls_c6;
ls_array0_copy(&(ls_v13),ls_c5);
ls_v14 = ls_c7;
ls_v15 = ls_array0_get(ls_v13,ls_v14);
...
ls_v17 = ls_c7;
ls_v18 = ls_from_u32(UINT32_C(1));
ls_v19 = ls_from_u32((uint32_t)((uint32_t)ls_v17 + (uint32_t)ls_v18));
ls_c7 = ls_v19;
goto ls_test26;
ls_end26: ;
ls_v20 = ls_c6;
{
int32_t ls_return = ls_v20;
ls_array0_clear(&ls_v0);
ls_array0_clear(&ls_c5);
return ls_return;
}
ls_array0_clear(&ls_v0);
ls_array0_clear(&ls_c5);
...
ls_array1 * ls_v0 = NULL;
bool ls_v1;
int32_t ls_v2;
ls_array0 * ls_v3 = NULL;
int32_t ls_v4;
int32_t ls_v5;
ls_array0 * ls_v6 = NULL;
ls_array1 * ls_v7 = NULL;
ls_array1 * ls_v8 = NULL;
int32_t ls_v9;
ls_array1 * ls_v10 = NULL;
int32_t ls_v11;
ls_array0 * ls_v12 = NULL;
int32_t ls_v13;
int32_t ls_v14;
ls_array1_copy(&(ls_v0),ls_c8);
ls_v1 = false;
if (ls_v1) {
ls_v2 = ls_from_u32(UINT32_C(1));
ls_array0_take(&(ls_v3),ls_array0_new(1));
ls_array0_push(ls_v3,ls_v2);
ls_v4 = ls_from_u32(UINT32_C(2));
ls_v5 = ls_from_u32(UINT32_C(3));
ls_array0_take(&(ls_v6),ls_array0_new(2));
ls_array0_push(ls_v6,ls_v4);
ls_array0_push(ls_v6,ls_v5);
ls_array1_take(&(ls_v7),ls_array1_new(2));
ls_array1_push(ls_v7,ls_v3);
ls_array1_push(ls_v7,ls_v6);
ls_array1_copy(&(ls_c8),ls_v7);
ls_array1_clear(&ls_v7);
ls_array0_clear(&ls_v6);
ls_array0_clear(&ls_v3);
}
ls_array1_copy(&(ls_v8),ls_c8);
ls_v9 = (int32_t)ls_v8->length;
ls_array1_copy(&(ls_v10),ls_c8);
ls_v11 = ls_from_u32(UINT32_C(1));
ls_array0_copy(&(ls_v12),ls_array1_get(ls_v10,ls_v11));
ls_v13 = (int32_t)ls_v12->length;
ls_v14 = ls_from_u32((uint32_t)((uint32_t)ls_v9 + (uint32_t)ls_v13));
{
...
static void ls_fn3(ls_native_object * ls_c9,ls_array0 * ls_c10) {
ls_native_retain(ls_c9);
ls_native_retain(ls_c10);
ls_array0 * ls_v0 = NULL;
bool ls_v1;
ls_array0 * ls_v2 = NULL;
ls_native_object * ls_v3 = NULL;
ls_array0 * ls_v4 = NULL;
ls_array0_copy(&(ls_v0),ls_c10);
ls_v1 = false;
if (ls_v1) {
ls_array0_take(&(ls_v2),ls_array0_new(0));
ls_array0_copy(&(ls_c10),ls_v2);
ls_array0_clear(&ls_v2);
}
ls_object_copy(&(ls_v3),ls_c9);
ls_array0_copy(&(ls_v4),ls_c10);
ls_array0_copy(&(((ls_object0 *)ls_v3)->ls_m0),ls_v4);
...
static int32_t ls_fn4(ls_native_object * ls_c11) {
ls_native_retain(ls_c11);
ls_native_object * ls_v0 = NULL;
ls_array0 * ls_v1 = NULL;
int32_t ls_v2;
ls_object_copy(&(ls_v0),ls_c11);
ls_array0_copy(&(ls_v1),((ls_object0 *)ls_v0)->ls_m0);
ls_v2 = (int32_t)ls_v1->length;
{

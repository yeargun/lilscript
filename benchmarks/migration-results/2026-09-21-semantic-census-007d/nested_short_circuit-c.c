...
struct ls_array0 { ls_native_object owner; size_t length; size_t capacity; bool *items; };
static void ls_array0_acquire(bool value) { (void)value; }
static void ls_array0_drop(bool value) { (void)value; }
...
static int32_t ls_array0_push_owned(ls_array0 *array, bool value) {
...
static int32_t ls_array0_push(ls_array0 *array, bool value) {
...
static bool ls_array0_get(ls_array0 *array, int32_t index) {
if (index < 0 || (size_t)index >= array->length) { ls_native_undefined_element(); return array->items[0]; }
return array->items[index];
}
static void ls_array0_set(ls_array0 *array, int32_t index, bool value) {
...
static bool ls_array0_pop(ls_array0 *array) {
...
static ls_array0 *ls_array0_fill(ls_array0 *array, bool value) {
...
static int32_t ls_array0_index_of(ls_array0 *array, bool right) {
for (size_t index = 0; index < array->length; index++) { bool left = array->items[index]; if (left == right) return (int32_t)index; }
return -1;
}
static bool ls_array0_includes(ls_array0 *array, bool right, int32_t start) {
size_t length = array->length;
...
static bool ls_fn1(bool ls_c3,int32_t ls_c4,bool ls_c5);
static void ls_init0(void) {
...
ls_array0_copy(&(ls_c1),ls_v5);
ls_v6 = true;
ls_v7 = false;
ls_v8 = false;
ls_v9 = true;
ls_array0_take(&(ls_v10),ls_array0_new(4));
ls_array0_push(ls_v10,ls_v6);
ls_array0_push(ls_v10,ls_v7);
ls_array0_push(ls_v10,ls_v8);
ls_array0_push(ls_v10,ls_v9);
ls_array0_copy(&(ls_c2),ls_v10);
ls_v11 = ls_from_u32(UINT32_C(0));
ls_c6 = ls_v11;
ls_test38: ;
ls_v12 = ls_c6;
ls_array0_copy(&(ls_v13),ls_c1);
ls_v14 = (int32_t)ls_v13->length;
ls_v15 = ls_v12 < ls_v14;
ls_array0_clear(&ls_v13);
if (!ls_v15) goto ls_end38;
ls_array0_copy(&(ls_v17),ls_c1);
ls_v18 = ls_c6;
ls_v19 = ls_array0_get(ls_v17,ls_v18);
ls_v20 = ls_c6;
ls_v21 = ls_from_u32(UINT32_C(1));
ls_v22 = ls_from_u32((uint32_t)((uint32_t)ls_v20 - (uint32_t)ls_v21));
ls_array0_copy(&(ls_v23),ls_c2);
ls_v24 = ls_c6;
ls_v25 = ls_array0_get(ls_v23,ls_v24);
ls_v26 = ls_fn1(ls_v19,ls_v22,ls_v25);
puts(ls_v26 ? "true" : "false");
ls_array0_clear(&ls_v23);
ls_array0_clear(&ls_v17);
ls_update38: ;
ls_v28 = ls_c6;
ls_v29 = ls_from_u32(UINT32_C(1));
ls_v30 = ls_from_u32((uint32_t)((uint32_t)ls_v28 + (uint32_t)ls_v29));
ls_c6 = ls_v30;
goto ls_test38;
ls_end38: ;

...
static void ls_array0_acquire(ls_string value) { (void)value; }
static void ls_array0_drop(ls_string value) { (void)value; }
...
static int32_t ls_array0_push_owned(ls_array0 *array, ls_string value) {
...
static int32_t ls_array0_push(ls_array0 *array, ls_string value) {
ls_array0_acquire(value);
return ls_array0_push_owned(array, value);
}
static void ls_array0_hole(ls_array0 *array) { ls_array0_push(array, (ls_string){NULL,0}); }
static ls_string ls_array0_get(ls_array0 *array, int32_t index) {
if (index < 0 || (size_t)index >= array->length) { return (ls_string){NULL,0}; }
return array->items[index];
}
static void ls_array0_set(ls_array0 *array, int32_t index, ls_string value) {
...
static ls_string ls_array0_pop(ls_array0 *array) {
...
static ls_array0 *ls_array0_fill(ls_array0 *array, ls_string value) {
...
static int32_t ls_array0_index_of(ls_array0 *array, ls_string right) {
...
static bool ls_array0_includes(ls_array0 *array, ls_string right, int32_t start) {
size_t length = array->length;
...
static ls_array0 *ls_string_split(ls_string text, ls_string separator) {
ls_array0 *parts = ls_array0_new(0);
if (!separator.length) {
for (size_t index = 0; index < text.length; index++) ls_array0_push(parts, ls_string_view(text, index, index + 1));
return parts;
}
if (!text.length) { ls_array0_push(parts, text); return parts; }
size_t start = 0;
for (size_t at = 0; at + separator.length <= text.length;) {
if (ls_string_matches(text, at, separator)) { ls_array0_push(parts, ls_string_view(text, start, at)); at += separator.length; start = at; }
else at++;
}
ls_array0_push(parts, ls_string_view(text, start, text.length));
return parts;
}
static const uint16_t ls_s0[] = {65,};
static const uint16_t ls_s1[] = {66,};
static const uint16_t ls_s2[] = {67,};
...
ls_v2 = (ls_string){ls_s2,sizeof ls_s2/sizeof *ls_s2};
...
if (!ls_v9) goto ls_end23;
ls_v10 = ls_c1;
ls_array0_copy(&(ls_v11),ls_c0);
ls_v12 = ls_c2;
ls_v13 = ls_array0_get(ls_v11,ls_v12);
ls_v14 = ls_string_concat(ls_v10,ls_v13);
ls_c1 = ls_v14;

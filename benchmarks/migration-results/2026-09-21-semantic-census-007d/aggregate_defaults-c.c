...
typedef struct {
ls_native_object * (*code)(void *,ls_native_object *);
void *environment;
uint64_t identity;
} ls_callable1;
...
static inline ls_native_object * ls_callable1_call(ls_callable1 value,ls_native_object * ls_p0) {
ls_native_retain(value.environment);
ls_native_object * result = value.code(value.environment,ls_p0);
ls_native_release(value.environment);
return result;
...
static int32_t ls_fn1(ls_t0 ls_c5);
static void ls_fn2(ls_native_object * ls_c6,int32_t ls_c7);
static int32_t ls_fn3(ls_native_object * ls_c8);
static int32_t ls_fn4(ls_native_object * ls_c9);
static void ls_fn5(ls_native_object * ls_c10,ls_native_object * ls_c11);
static int32_t ls_fn6(ls_native_object * ls_c12);
static void ls_init0(void) {
int32_t ls_v7;
int32_t ls_v8;
ls_t0 ls_v9;
...
ls_v8 = ls_from_u32(UINT32_C(3));
ls_v9 = (ls_t0){ls_v7,ls_v8};
ls_v10 = ls_fn1(ls_v9);
printf("%ld\n",(long)ls_v10);
ls_v13 = ls_from_u32(UINT32_C(4));
ls_v14 = ls_from_u32(UINT32_C(5));
ls_v15 = (ls_t0){ls_v13,ls_v14};
ls_v16 = ls_v15;
ls_v17 = ls_fn1(ls_v16);
printf("%ld\n",(long)ls_v17);
ls_v20 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v20;
ls_object_take(&(ls_v21),(ls_native_object *)ls_o);
}
ls_v23 = ls_from_u32(UINT32_C(0));
ls_fn2(ls_v21,ls_v23);
ls_v25 = ls_fn4(ls_v21);
printf("%ld\n",(long)ls_v25);
ls_v28 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v28;
ls_object_take(&(ls_v29),(ls_native_object *)ls_o);
}
ls_v31 = ls_from_u32(UINT32_C(0));
ls_fn2(ls_v29,ls_v31);
ls_v33 = ls_fn4(ls_v29);
printf("%ld\n",(long)ls_v33);
ls_v36 = (ls_value){0};
{
ls_object1 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object1_destroy);
((ls_object1 *)ls_o)->ls_m0 = ls_value_to_object(ls_v36);
ls_native_retain(((ls_object1 *)ls_o)->ls_m0);
ls_object_take(&(ls_v37),(ls_native_object *)ls_o);
}
ls_v39 = ls_from_u32(UINT32_C(5));
ls_v40 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v40;
ls_object_take(&(ls_v41),(ls_native_object *)ls_o);
}
ls_fn2(ls_v41,ls_v39);
ls_fn5(ls_v37,ls_v41);
ls_v45 = ls_fn6(ls_v37);
printf("%ld\n",(long)ls_v45);
...
ls_v4 = (ls_t0){ls_v2,ls_v3};
ls_c5 = ls_v4;
}
ls_v5 = ls_c5.ls_f0;
ls_v6 = ls_c5.ls_f1;
ls_v7 = ls_from_u32((uint32_t)((uint32_t)ls_v5 + (uint32_t)ls_v6));
{
int32_t ls_return = ls_v7;
return ls_return;
}
}
static void ls_fn2(ls_native_object * ls_c6,int32_t ls_c7) {
...
ls_object_copy(&(ls_v3),ls_c6);
ls_v4 = ls_c7;
((ls_object0 *)ls_v3)->ls_m0 = ls_v4;
...
ls_fn2(ls_v3,ls_v5);
ls_object_copy(&(ls_c9),ls_v3);
ls_object_clear(&ls_v3);
}
ls_object_copy(&(ls_v7),ls_c9);
ls_v9 = ls_fn3(ls_v7);
{
...
ls_fn2(ls_v4,ls_v2);
ls_object_copy(&(ls_c11),ls_v4);
ls_object_clear(&ls_v4);
}
ls_object_copy(&(ls_v7),ls_c10);
ls_object_copy(&(ls_v8),ls_c11);
ls_object_copy(&(((ls_object1 *)ls_v7)->ls_m0),ls_v8);
...
{
ls_object1 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object1_destroy);
((ls_object1 *)ls_o)->ls_m0 = ls_value_to_object(ls_v2);
ls_native_retain(((ls_object1 *)ls_o)->ls_m0);
ls_object_take(&(ls_v3),(ls_native_object *)ls_o);
}
ls_v5 = ls_from_u32(UINT32_C(5));
ls_v6 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v6;
ls_object_take(&(ls_v7),(ls_native_object *)ls_o);
}
ls_fn2(ls_v7,ls_v5);
ls_fn5(ls_v3,ls_v7);
ls_object_copy(&(ls_c12),ls_v3);
ls_object_clear(&ls_v7);
ls_object_clear(&ls_v3);
}
ls_object_copy(&(ls_v11),ls_c12);
ls_object_copy(&(ls_v12),((ls_object1 *)ls_v11)->ls_m0);
ls_v13 = ((ls_object0 *)ls_v12)->ls_m0;
{
int32_t ls_return = ls_v13;

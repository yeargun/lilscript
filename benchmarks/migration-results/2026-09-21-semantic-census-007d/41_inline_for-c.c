...
static void ls_array1_acquire(ls_string value) { (void)value; }
static void ls_array1_drop(ls_string value) { (void)value; }
...
static int32_t ls_array1_push_owned(ls_array1 *array, ls_string value) {
if (array->length >= (size_t)INT32_MAX) ls_native_resource_failure();
ls_array1_reserve(array, array->length + 1);
array->items[array->length++] = value;
return (int32_t)array->length;
}
static int32_t ls_array1_push(ls_array1 *array, ls_string value) {
ls_array1_acquire(value);
return ls_array1_push_owned(array, value);
}
static void ls_array1_hole(ls_array1 *array) { ls_array1_push(array, (ls_string){NULL,0}); }
static ls_string ls_array1_get(ls_array1 *array, int32_t index) {
if (index < 0 || (size_t)index >= array->length) { return (ls_string){NULL,0}; }
return array->items[index];
}
static void ls_array1_set(ls_array1 *array, int32_t index, ls_string value) {
...
static ls_string ls_array1_pop(ls_array1 *array) {
if (!array->length) { return (ls_string){NULL,0}; }
return array->items[--array->length];
}
...
static ls_array1 *ls_array1_fill(ls_array1 *array, ls_string value) {
...
static int32_t ls_array1_index_of(ls_array1 *array, ls_string right) {
...
static bool ls_array1_includes(ls_array1 *array, ls_string right, int32_t start) {
size_t length = array->length;
size_t from = start >= 0 ? (size_t)start : ls_array_relative(start, length);
for (size_t index = from; index < length; index++) { ls_string left = array->items[index]; if (ls_string_equal(left, right)) return true; }
return false;
}
static ls_array1 *ls_string_split(ls_string text, ls_string separator) {
ls_array1 *parts = ls_array1_new(0);
if (!separator.length) {
for (size_t index = 0; index < text.length; index++) ls_array1_push(parts, ls_string_view(text, index, index + 1));
return parts;
}
if (!text.length) { ls_array1_push(parts, text); return parts; }
size_t start = 0;
for (size_t at = 0; at + separator.length <= text.length;) {
if (ls_string_matches(text, at, separator)) { ls_array1_push(parts, ls_string_view(text, start, at)); at += separator.length; start = at; }
else at++;
}
ls_array1_push(parts, ls_string_view(text, start, text.length));
return parts;
}
static const uint16_t ls_s1[] = {97,98,};
static const uint16_t ls_s2[] = {99,100,};
static void ls_init0(void);
static void ls_init0(void) {
int32_t ls_c0;
ls_array0 * ls_c4 = NULL;
int32_t ls_c5;
int32_t ls_c2;
ls_string ls_c1;
ls_array1 * ls_c6 = NULL;
int32_t ls_c7;
ls_string ls_c3;
int32_t ls_v0;
int32_t ls_v1;
...
ls_string ls_v23;
ls_string ls_v24;
ls_array1 * ls_v25 = NULL;
int32_t ls_v26;
int32_t ls_v27;
ls_array1 * ls_v28 = NULL;
int32_t ls_v29;
bool ls_v30;
ls_array1 * ls_v31 = NULL;
int32_t ls_v32;
ls_string ls_v33;
ls_string ls_v34;
ls_string ls_v35;
...
ls_v3 = ls_from_u32(UINT32_C(3));
ls_v4 = ls_from_u32(UINT32_C(4));
ls_array0_take(&(ls_v5),ls_array0_new(4));
ls_array0_push(ls_v5,ls_v1);
ls_array0_push(ls_v5,ls_v2);
ls_array0_push(ls_v5,ls_v3);
ls_array0_push(ls_v5,ls_v4);
ls_array0_copy(&(ls_c4),ls_v5);
ls_v6 = ls_from_u32(UINT32_C(0));
ls_c5 = ls_v6;
ls_test27: ;
ls_v7 = ls_c5;
ls_array0_copy(&(ls_v8),ls_c4);
ls_v9 = (int32_t)ls_v8->length;
ls_v10 = ls_v7 < ls_v9;
ls_array0_clear(&ls_v8);
if (!ls_v10) goto ls_end27;
ls_array0_copy(&(ls_v11),ls_c4);
ls_v12 = ls_c5;
ls_v13 = ls_array0_get(ls_v11,ls_v12);
ls_c2 = ls_v13;
ls_v14 = ls_c0;
ls_v15 = ls_c2;
...
ls_v20 = ls_c0;
printf("%ld\n",(long)ls_v20);
ls_v22 = (ls_string){NULL,0};
ls_c1 = ls_v22;
ls_v23 = (ls_string){ls_s1,sizeof ls_s1/sizeof *ls_s1};
ls_v24 = (ls_string){ls_s2,sizeof ls_s2/sizeof *ls_s2};
ls_array1_take(&(ls_v25),ls_array1_new(2));
ls_array1_push(ls_v25,ls_v23);
ls_array1_push(ls_v25,ls_v24);
ls_array1_copy(&(ls_c6),ls_v25);
ls_v26 = ls_from_u32(UINT32_C(0));
ls_c7 = ls_v26;
ls_test57: ;
ls_v27 = ls_c7;
ls_array1_copy(&(ls_v28),ls_c6);
ls_v29 = (int32_t)ls_v28->length;
ls_v30 = ls_v27 < ls_v29;
ls_array1_clear(&ls_v28);
if (!ls_v30) goto ls_end57;
ls_array1_copy(&(ls_v31),ls_c6);
ls_v32 = ls_c7;
ls_v33 = ls_array1_get(ls_v31,ls_v32);
ls_c3 = ls_v33;
ls_v34 = ls_c1;
ls_v35 = ls_c3;
ls_v36 = ls_string_concat(ls_v34,ls_v35);
ls_c1 = ls_v36;
ls_array1_clear(&ls_v31);
ls_update57: ;
ls_v37 = ls_c7;
ls_v38 = ls_from_u32(UINT32_C(1));
ls_v39 = ls_from_u32((uint32_t)((uint32_t)ls_v37 + (uint32_t)ls_v38));
ls_c7 = ls_v39;
goto ls_test57;
ls_end57: ;
ls_array1_clear(&ls_c6);
ls_array1_clear(&ls_v25);
ls_v40 = ls_c1;

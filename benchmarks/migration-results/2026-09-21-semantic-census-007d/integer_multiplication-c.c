...
static inline int32_t ls_imul(int32_t left, int32_t right) {
...
int32_t ls_v13;
int32_t ls_v14;
ls_array0 * ls_v15 = NULL;
int32_t ls_v16;
bool ls_v17;
ls_array0 * ls_v18 = NULL;
int32_t ls_v19;
int32_t ls_v20;
ls_array0 * ls_v21 = NULL;
int32_t ls_v22;
int32_t ls_v23;
int32_t ls_v24;
...
int32_t ls_v35;
int32_t ls_v36;
ls_v0 = ls_from_u32(UINT32_C(2147483647));
ls_v1 = ls_from_u32(UINT32_C(2147483647));
ls_v2 = ls_from_u32(UINT32_C(123456789));
ls_v3 = ls_from_u32(UINT32_C(2147483647));
ls_v4 = ls_from_u32((uint32_t)(UINT32_C(0) - (uint32_t)ls_v3));
ls_v5 = ls_from_u32(UINT32_C(1));
ls_v6 = ls_from_u32((uint32_t)((uint32_t)ls_v4 - (uint32_t)ls_v5));
ls_array0_take(&(ls_v7),ls_array0_new(4));
ls_array0_push(ls_v7,ls_v0);
ls_array0_push(ls_v7,ls_v1);
ls_array0_push(ls_v7,ls_v2);
ls_array0_push(ls_v7,ls_v6);
ls_array0_copy(&(ls_c0),ls_v7);
ls_v8 = ls_from_u32(UINT32_C(2147483647));
ls_v9 = ls_from_u32(UINT32_C(2147483646));
ls_v10 = ls_from_u32(UINT32_C(987654321));
ls_v11 = ls_from_u32(UINT32_C(2147483647));
ls_array0_take(&(ls_v12),ls_array0_new(4));
ls_array0_push(ls_v12,ls_v8);
ls_array0_push(ls_v12,ls_v9);
ls_array0_push(ls_v12,ls_v10);
ls_array0_push(ls_v12,ls_v11);
ls_array0_copy(&(ls_c1),ls_v12);
ls_v13 = ls_from_u32(UINT32_C(0));
ls_c2 = ls_v13;
ls_test44: ;
ls_v14 = ls_c2;
ls_array0_copy(&(ls_v15),ls_c0);
ls_v16 = (int32_t)ls_v15->length;
ls_v17 = ls_v14 < ls_v16;
ls_array0_clear(&ls_v15);
if (!ls_v17) goto ls_end44;
ls_array0_copy(&(ls_v18),ls_c0);
ls_v19 = ls_c2;
ls_v20 = ls_array0_get(ls_v18,ls_v19);
ls_array0_copy(&(ls_v21),ls_c1);
ls_v22 = ls_c2;
ls_v23 = ls_array0_get(ls_v21,ls_v22);
ls_v24 = ls_mul(ls_v20,ls_v23);
printf("%ld\n",(long)ls_v24);
ls_array0_copy(&(ls_v26),ls_c0);
ls_v27 = ls_c2;
ls_v28 = ls_array0_get(ls_v26,ls_v27);
ls_array0_copy(&(ls_v29),ls_c1);
ls_v30 = ls_c2;
ls_v31 = ls_array0_get(ls_v29,ls_v30);
ls_v32 = ls_imul(ls_v28,ls_v31);
printf("%ld\n",(long)ls_v32);
ls_array0_clear(&ls_v29);
ls_array0_clear(&ls_v26);
ls_array0_clear(&ls_v21);
ls_array0_clear(&ls_v18);
ls_update44: ;
ls_v34 = ls_c2;
ls_v35 = ls_from_u32(UINT32_C(1));
ls_v36 = ls_from_u32((uint32_t)((uint32_t)ls_v34 + (uint32_t)ls_v35));
ls_c2 = ls_v36;
goto ls_test44;
ls_end44: ;

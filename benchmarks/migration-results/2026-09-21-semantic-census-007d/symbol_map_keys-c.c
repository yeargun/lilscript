...
static const uint16_t ls_s0[] = {101,118,101,110,116,};
static const uint16_t ls_s1[] = {98,114,111,97,100,99,97,115,116,};
...
bool ls_v46;
int32_t ls_v47;
ls_native_object * ls_v49 = NULL;
ls_native_object * ls_v50 = NULL;
bool ls_v51;
ls_native_object * ls_v53 = NULL;
ls_native_object * ls_v54 = NULL;
bool ls_v55;
ls_native_object * ls_v57 = NULL;
ls_native_object * ls_v58 = NULL;
ls_native_object * ls_v59 = NULL;
bool ls_v60;
ls_v0 = (ls_string){ls_s0,sizeof ls_s0/sizeof *ls_s0};
ls_object_take(&(ls_v1),ls_symbol_new());
ls_object_copy(&(ls_c0),ls_v1);
ls_object_take(&(ls_v2),ls_symbol_new());
ls_object_copy(&(ls_c1),ls_v2);
ls_object_take(&(ls_v3),ls_map_new());
ls_object_copy(&(ls_c2),ls_v3);
ls_object_copy(&(ls_v4),ls_c2);
ls_object_copy(&(ls_v5),ls_c0);
ls_v6 = ls_from_u32(UINT32_C(10));
ls_map_set(ls_v4,ls_value_symbol(ls_v5),ls_value_int(ls_v6));
ls_object_copy(&(ls_v7),ls_v4);
ls_object_copy(&(ls_v8),ls_c2);
ls_v9 = (ls_string){ls_s1,sizeof ls_s1/sizeof *ls_s1};
ls_v10 = ls_from_u32(UINT32_C(20));
ls_map_set(ls_v8,ls_value_string(ls_v9),ls_value_int(ls_v10));
ls_object_copy(&(ls_v11),ls_v8);
ls_object_copy(&(ls_v12),ls_c2);
ls_object_copy(&(ls_v13),ls_c1);
ls_v14 = ls_from_u32(UINT32_C(30));
ls_map_set(ls_v12,ls_value_symbol(ls_v13),ls_value_int(ls_v14));
ls_object_copy(&(ls_v15),ls_v12);
ls_object_copy(&(ls_v16),ls_c2);
ls_object_copy(&(ls_v17),ls_c0);
ls_v18 = ls_map_has(ls_v16,ls_value_symbol(ls_v17));
puts(ls_v18 ? "true" : "false");
ls_object_copy(&(ls_v20),ls_c2);
ls_v21 = (ls_string){ls_s0,sizeof ls_s0/sizeof *ls_s0};
ls_object_take(&(ls_v22),ls_symbol_new());
ls_v23 = ls_map_has(ls_v20,ls_value_symbol(ls_v22));
puts(ls_v23 ? "true" : "false");
ls_object_copy(&(ls_v25),ls_c2);
ls_object_copy(&(ls_v26),ls_c0);
ls_v27 = ls_map_get(ls_v25,ls_value_symbol(ls_v26));
ls_c3 = ls_v27;
ls_v28 = ls_c3;
ls_v29 = (ls_value){0};
ls_v30 = !ls_value_equal(ls_v28,ls_v29);
if (ls_v30) {
ls_v31 = ls_value_to_int(ls_c3);
printf("%ld\n",(long)ls_v31);
}
ls_object_copy(&(ls_v33),ls_c2);
ls_v34 = (ls_string){ls_s1,sizeof ls_s1/sizeof *ls_s1};
ls_v35 = ls_map_get(ls_v33,ls_value_string(ls_v34));
ls_c4 = ls_v35;
ls_v36 = ls_c4;
ls_v37 = (ls_value){0};
ls_v38 = !ls_value_equal(ls_v36,ls_v37);
if (ls_v38) {
ls_v39 = ls_value_to_int(ls_c4);
printf("%ld\n",(long)ls_v39);
}
ls_object_copy(&(ls_v41),ls_c2);
ls_object_copy(&(ls_v42),ls_c1);
ls_v43 = ls_map_get(ls_v41,ls_value_symbol(ls_v42));
ls_c5 = ls_v43;
ls_v44 = ls_c5;
ls_v45 = (ls_value){0};
ls_v46 = !ls_value_equal(ls_v44,ls_v45);
if (ls_v46) {
ls_v47 = ls_value_to_int(ls_c5);
printf("%ld\n",(long)ls_v47);
}
ls_object_copy(&(ls_v49),ls_c0);
ls_object_copy(&(ls_v50),ls_c0);
ls_v51 = ls_v49 == ls_v50;
puts(ls_v51 ? "true" : "false");
ls_object_copy(&(ls_v53),ls_c0);
ls_object_copy(&(ls_v54),ls_c1);
ls_v55 = ls_v53 == ls_v54;
puts(ls_v55 ? "true" : "false");
ls_object_copy(&(ls_v57),ls_c0);
ls_object_copy(&(ls_c6),ls_v57);
ls_object_copy(&(ls_v58),ls_c2);
ls_object_copy(&(ls_v59),ls_c6);
ls_v60 = ls_map_has(ls_v58,ls_value_symbol(ls_v59));
puts(ls_v60 ? "true" : "false");

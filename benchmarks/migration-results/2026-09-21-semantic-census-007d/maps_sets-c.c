...
static inline ls_native_object * ls_callable1_call(ls_callable1 value) {
ls_native_retain(value.environment);
...
static const uint16_t ls_s4[] = {97,108,112,104,97,};
static const uint16_t ls_s5[] = {98,101,116,97,};
static const uint16_t ls_s6[] = {109,105,115,115,105,110,103,};
static const uint16_t ls_s7[] = {102,105,114,115,116,};
static void ls_init0(void);
static void ls_fn1(ls_native_object * ls_c12,int32_t ls_c13);
static void ls_init0(void) {
...
ls_string ls_v25;
int32_t ls_v26;
ls_native_object * ls_v27 = NULL;
ls_string ls_v28;
int32_t ls_v29;
ls_native_object * ls_v30 = NULL;
ls_native_object * ls_v31 = NULL;
ls_string ls_v32;
int32_t ls_v33;
ls_native_object * ls_v34 = NULL;
ls_native_object * ls_v35 = NULL;
int32_t ls_v36;
ls_native_object * ls_v38 = NULL;
ls_string ls_v39;
ls_value ls_v40 = {0};
ls_value ls_v41 = {0};
ls_value ls_v42 = {0};
...
ls_value ls_v49 = {0};
bool ls_v50;
ls_native_object * ls_v52 = NULL;
ls_string ls_v53;
bool ls_v54;
ls_native_object * ls_v56 = NULL;
ls_string ls_v57;
bool ls_v58;
...
ls_native_object * ls_v69 = NULL;
int32_t ls_v70;
ls_native_object * ls_v72 = NULL;
ls_native_object * ls_v73 = NULL;
int32_t ls_v74;
ls_native_object * ls_v75 = NULL;
int32_t ls_v76;
...
ls_native_object * ls_v112 = NULL;
ls_native_object * ls_v113 = NULL;
ls_string ls_v114;
ls_native_object * ls_v115 = NULL;
ls_native_object * ls_v116 = NULL;
ls_native_object * ls_v117 = NULL;
bool ls_v118;
ls_native_object * ls_v120 = NULL;
ls_native_object * ls_v121 = NULL;
bool ls_v122;
ls_object_take(&(ls_v1),ls_map_new());
ls_object_take(&(ls_v2),ls_map_new());
{
ls_object1 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object1_destroy);
((ls_object1 *)ls_o)->ls_m0 = ls_v1;
ls_native_retain(((ls_object1 *)ls_o)->ls_m0);
((ls_object1 *)ls_o)->ls_m1 = ls_v2;
ls_native_retain(((ls_object1 *)ls_o)->ls_m1);
ls_object_take(&(ls_v3),(ls_native_object *)ls_o);
}
ls_object_copy(&(ls_c2),ls_v3);
ls_object_copy(&(ls_v4),ls_c2);
ls_object_copy(&(ls_v5),((ls_object1 *)ls_v4)->ls_m0);
ls_v6 = ls_map_size(ls_v5);
printf("%ld\n",(long)ls_v6);
ls_object_copy(&(ls_v8),ls_c2);
ls_object_copy(&(ls_v9),((ls_object1 *)ls_v8)->ls_m1);
ls_v10 = ls_map_size(ls_v9);
printf("%ld\n",(long)ls_v10);
ls_object_take(&(ls_v12),ls_map_new());
ls_object_copy(&(ls_c3),ls_v12);
ls_object_take(&(ls_v13),ls_map_new());
ls_object_copy(&(ls_c4),ls_v13);
ls_object_copy(&(ls_v14),ls_c3);
ls_v15 = ls_map_size(ls_v14);
printf("%ld\n",(long)ls_v15);
ls_object_copy(&(ls_v17),ls_c4);
ls_v18 = ls_map_size(ls_v17);
printf("%ld\n",(long)ls_v18);
ls_object_take(&(ls_v20),ls_map_new());
ls_object_copy(&(ls_c5),ls_v20);
ls_object_copy(&(ls_v21),ls_c5);
ls_v22 = ls_map_size(ls_v21);
printf("%ld\n",(long)ls_v22);
ls_object_copy(&(ls_v24),ls_c5);
ls_v25 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v26 = ls_from_u32(UINT32_C(10));
ls_map_set(ls_v24,ls_value_string(ls_v25),ls_value_int(ls_v26));
ls_object_copy(&(ls_v27),ls_v24);
ls_v28 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
ls_v29 = ls_from_u32(UINT32_C(20));
ls_map_set(ls_v27,ls_value_string(ls_v28),ls_value_int(ls_v29));
ls_object_copy(&(ls_v30),ls_v27);
ls_object_copy(&(ls_v31),ls_c5);
ls_v32 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v33 = ls_from_u32(UINT32_C(11));
ls_map_set(ls_v31,ls_value_string(ls_v32),ls_value_int(ls_v33));
ls_object_copy(&(ls_v34),ls_v31);
ls_object_copy(&(ls_v35),ls_c5);
ls_v36 = ls_map_size(ls_v35);
printf("%ld\n",(long)ls_v36);
ls_object_copy(&(ls_v38),ls_c5);
ls_v39 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v40 = ls_map_get(ls_v38,ls_value_string(ls_v39));
ls_c6 = ls_v40;
ls_v41 = ls_c6;
ls_v42 = (ls_value){0};
ls_v43 = !ls_value_equal(ls_v41,ls_v42);
if (ls_v43) {
ls_v44 = ls_value_to_int(ls_c6);
printf("%ld\n",(long)ls_v44);
}
ls_object_copy(&(ls_v46),ls_c5);
ls_v47 = (ls_string){ls_s6,sizeof ls_s6/sizeof *ls_s6};
ls_v48 = ls_map_get(ls_v46,ls_value_string(ls_v47));
ls_v49 = (ls_value){0};
ls_v50 = ls_value_equal(ls_v48,ls_v49);
puts(ls_v50 ? "true" : "false");
ls_object_copy(&(ls_v52),ls_c5);
ls_v53 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
ls_v54 = ls_map_has(ls_v52,ls_value_string(ls_v53));
puts(ls_v54 ? "true" : "false");
ls_object_copy(&(ls_v56),ls_c5);
ls_v57 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
ls_v58 = ls_map_delete(ls_v56,ls_value_string(ls_v57));
puts(ls_v58 ? "true" : "false");
ls_object_copy(&(ls_v60),ls_c5);
ls_v61 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
ls_v62 = ls_map_delete(ls_v60,ls_value_string(ls_v61));
puts(ls_v62 ? "true" : "false");
ls_object_copy(&(ls_v64),ls_c5);
ls_v65 = ls_map_size(ls_v64);
printf("%ld\n",(long)ls_v65);
ls_object_copy(&(ls_v67),ls_c5);
ls_map_clear(ls_v67);
ls_object_copy(&(ls_v69),ls_c5);
ls_v70 = ls_map_size(ls_v69);
printf("%ld\n",(long)ls_v70);
ls_object_take(&(ls_v72),ls_map_new());
ls_object_copy(&(ls_c7),ls_v72);
ls_object_copy(&(ls_v73),ls_c7);
ls_v74 = ls_from_u32(UINT32_C(3));
ls_map_set(ls_v73,ls_value_int(ls_v74),(ls_value){0});
ls_object_copy(&(ls_v75),ls_v73);
ls_v76 = ls_from_u32(UINT32_C(3));
ls_map_set(ls_v75,ls_value_int(ls_v76),(ls_value){0});
ls_object_copy(&(ls_v77),ls_v75);
ls_v78 = ls_from_u32(UINT32_C(5));
ls_map_set(ls_v77,ls_value_int(ls_v78),(ls_value){0});
ls_object_copy(&(ls_v79),ls_v77);
ls_object_copy(&(ls_v80),ls_c7);
ls_v81 = ls_map_size(ls_v80);
printf("%ld\n",(long)ls_v81);
ls_object_copy(&(ls_v83),ls_c7);
ls_v84 = ls_from_u32(UINT32_C(3));
ls_v85 = ls_map_has(ls_v83,ls_value_int(ls_v84));
puts(ls_v85 ? "true" : "false");
ls_object_copy(&(ls_v87),ls_c7);
ls_v88 = ls_from_u32(UINT32_C(3));
ls_v89 = ls_map_delete(ls_v87,ls_value_int(ls_v88));
puts(ls_v89 ? "true" : "false");
ls_object_copy(&(ls_v91),ls_c7);
ls_v92 = ls_from_u32(UINT32_C(3));
ls_v93 = ls_map_has(ls_v91,ls_value_int(ls_v92));
puts(ls_v93 ? "true" : "false");
ls_object_copy(&(ls_v95),ls_c7);
ls_map_clear(ls_v95);
ls_object_copy(&(ls_v97),ls_c7);
ls_v98 = ls_map_size(ls_v97);
printf("%ld\n",(long)ls_v98);
ls_v100 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v100;
ls_object_take(&(ls_v101),(ls_native_object *)ls_o);
}
ls_v103 = ls_from_u32(UINT32_C(1));
ls_fn1(ls_v101,ls_v103);
ls_object_copy(&(ls_c8),ls_v101);
ls_object_copy(&(ls_v105),ls_c8);
ls_object_copy(&(ls_c9),ls_v105);
ls_v106 = ls_from_u32(UINT32_C(0));
{
ls_object0 *ls_o = ls_native_allocate(sizeof *ls_o, ls_object0_destroy);
((ls_object0 *)ls_o)->ls_m0 = ls_v106;
ls_object_take(&(ls_v107),(ls_native_object *)ls_o);
}
ls_v109 = ls_from_u32(UINT32_C(1));
ls_fn1(ls_v107,ls_v109);
ls_object_copy(&(ls_c10),ls_v107);
ls_object_take(&(ls_v111),ls_map_new());
ls_object_copy(&(ls_c11),ls_v111);
ls_object_copy(&(ls_v112),ls_c11);
ls_object_copy(&(ls_v113),ls_c8);
ls_v114 = (ls_string){ls_s7,sizeof ls_s7/sizeof *ls_s7};
ls_map_set(ls_v112,ls_value_object(ls_v113),ls_value_string(ls_v114));
ls_object_copy(&(ls_v115),ls_v112);
ls_object_copy(&(ls_v116),ls_c11);
ls_object_copy(&(ls_v117),ls_c9);
ls_v118 = ls_map_has(ls_v116,ls_value_object(ls_v117));
puts(ls_v118 ? "true" : "false");
ls_object_copy(&(ls_v120),ls_c11);
ls_object_copy(&(ls_v121),ls_c10);
ls_v122 = ls_map_has(ls_v120,ls_value_object(ls_v121));
puts(ls_v122 ? "true" : "false");
ls_object_clear(&ls_v121);
ls_object_clear(&ls_v120);
ls_object_clear(&ls_v117);
ls_object_clear(&ls_v116);
ls_object_clear(&ls_v115);
ls_object_clear(&ls_v113);
ls_object_clear(&ls_v112);
...
ls_object_clear(&ls_v75);
ls_object_clear(&ls_v73);
...
ls_object_clear(&ls_v56);
ls_object_clear(&ls_v52);
ls_object_clear(&ls_v46);
ls_object_clear(&ls_v38);

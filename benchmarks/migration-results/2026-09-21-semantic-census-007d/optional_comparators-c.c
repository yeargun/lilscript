...
#endif
typedef struct {
bool (*code)(void *,ls_value,ls_value);
void *environment;
uint64_t identity;
} ls_callable0;
...
static inline bool ls_callable0_call(ls_callable0 value,ls_value ls_p0,ls_value ls_p1) {
ls_native_retain(value.environment);
...
typedef struct {
bool (*code)(void *,ls_string,ls_string);
void *environment;
uint64_t identity;
} ls_callable2;
...
static inline bool ls_callable2_call(ls_callable2 value,ls_string ls_p0,ls_string ls_p1) {
ls_native_retain(value.environment);
bool result = value.code(value.environment,ls_p0,ls_p1);
ls_native_release(value.environment);
return result;
...
static inline ls_callable3 ls_callable3_retain(ls_callable3 value) {
ls_native_retain(value.environment);
return value;
}
static inline void ls_callable3_release(ls_callable3 value) { ls_native_release(value.environment); }
static inline void ls_callable3_copy(ls_callable3 *destination, ls_callable3 value) {
ls_native_retain(value.environment);
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable3_take(ls_callable3 *destination, ls_callable3 value) {
ls_native_release(destination->environment);
*destination = value;
}
static inline void ls_callable3_clear(ls_callable3 *destination) {
ls_native_release(destination->environment);
*destination = (ls_callable3){0};
}
static inline bool ls_callable3_call(ls_callable3 value,int32_t ls_p0,int32_t ls_p1) {
ls_native_retain(value.environment);
bool result = value.code(value.environment,ls_p0,ls_p1);
ls_native_release(value.environment);
return result;
...
static ls_value ls_value_callable3(ls_callable3 value) { ls_value result = {LS_CALLABLE, 3}; memcpy(&result.as.c, &value, sizeof value); return result; }
static ls_callable3 ls_value_to_callable3(ls_value value) {
...
typedef struct { ls_native_object owner; ls_callable3 inner; } ls_adapter3_0;
static void ls_adapter3_0_destroy(ls_native_object *owner) { ls_callable3_clear(&((ls_adapter3_0 *)owner)->inner); }
static bool ls_adapter3_0_code(void *environment,ls_value ls_p0,ls_value ls_p1) {
ls_adapter3_0 *adapter = environment;
return adapter->inner.code(adapter->inner.environment,ls_value_to_int(ls_p0),ls_value_to_int(ls_p1));
}
static ls_callable0 ls_adapt3_0(ls_callable3 inner) {
ls_adapter3_0 *adapter = ls_native_allocate(sizeof *adapter, ls_adapter3_0_destroy);
ls_native_retain(inner.environment);
adapter->inner = inner;
return (ls_callable0){ls_adapter3_0_code, adapter, inner.identity};
}
static ls_value ls_adapt_value3_0(ls_value value) {
if (value.tag != LS_CALLABLE) { ls_value_retain(value); return value; }
return ls_value_callable0(ls_adapt3_0(ls_value_to_callable3(value)));
}
typedef struct { ls_native_object owner; ls_callable2 inner; } ls_adapter2_0;
static void ls_adapter2_0_destroy(ls_native_object *owner) { ls_callable2_clear(&((ls_adapter2_0 *)owner)->inner); }
static bool ls_adapter2_0_code(void *environment,ls_value ls_p0,ls_value ls_p1) {
ls_adapter2_0 *adapter = environment;
return adapter->inner.code(adapter->inner.environment,ls_value_to_string(ls_p0),ls_value_to_string(ls_p1));
}
static ls_callable0 ls_adapt2_0(ls_callable2 inner) {
ls_adapter2_0 *adapter = ls_native_allocate(sizeof *adapter, ls_adapter2_0_destroy);
ls_native_retain(inner.environment);
adapter->inner = inner;
return (ls_callable0){ls_adapter2_0_code, adapter, inner.identity};
}
static ls_value ls_adapt_value2_0(ls_value value) {
if (value.tag != LS_CALLABLE) { ls_value_retain(value); return value; }
return ls_value_callable0(ls_adapt2_0(ls_value_to_callable2(value)));
}
static const uint16_t ls_s2[] = {111,108,100,};
static const uint16_t ls_s3[] = {110,101,119,};
static const uint16_t ls_s4[] = {108,101,102,116,};
static const uint16_t ls_s5[] = {110,101,120,116,};
static void ls_init0(void);
static ls_value ls_fn1(ls_value ls_c2,ls_value ls_c3,ls_value ls_c4);
static bool ls_fn2(ls_string ls_c6,ls_string ls_c7);
static bool ls_adapter2(void *environment,ls_string ls_p0,ls_string ls_p1) {
(void)environment;
return ls_fn2(ls_p0,ls_p1);
}
static void ls_init0(void) {
int32_t ls_v3;
int32_t ls_v4;
...
ls_v4 = ls_from_u32(UINT32_C(4));
ls_value_take(&(ls_v5),(ls_value){0});
{
ls_value ls_adapted2 = ls_adapt_value3_0(ls_v5);
ls_v6 = ls_value_to_int(ls_fn1(ls_value_int(ls_v3),ls_value_int(ls_v4),ls_adapted2));
ls_value_clear(&ls_adapted2);
}
printf("%ld\n",(long)ls_v6);
ls_v9 = (ls_string){ls_s2,sizeof ls_s2/sizeof *ls_s2};
ls_v10 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_value_take(&(ls_v11),(ls_value){0});
{
ls_value ls_adapted2 = ls_adapt_value2_0(ls_v11);
ls_v12 = ls_value_to_string(ls_fn1(ls_value_string(ls_v9),ls_value_string(ls_v10),ls_adapted2));
ls_value_clear(&ls_adapted2);
}
ls_print_string(ls_v12);
ls_v15 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v16 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
{
ls_callable0 ls_adapted2 = ls_adapt2_0((ls_callable2){ls_adapter2,NULL,UINT64_C(3)});
ls_v18 = ls_value_to_string(ls_fn1(ls_value_string(ls_v15),ls_value_string(ls_v16),ls_value_callable0(ls_adapted2)));
ls_callable0_clear(&ls_adapted2);
}
ls_print_string(ls_v18);
ls_value_clear(&ls_v11);
ls_value_clear(&ls_v5);
}
static ls_value ls_fn1(ls_value ls_c2,ls_value ls_c3,ls_value ls_c4) {
ls_value_retain(ls_c2);
ls_value_retain(ls_c3);
ls_value_retain(ls_c4);
...
ls_value ls_v22 = {0};
ls_value ls_v23 = {0};
ls_value_copy(&(ls_v0),ls_c4);
ls_v1 = false;
if (ls_v1) {
ls_value_take(&(ls_v2),(ls_value){0});
ls_value_copy(&(ls_c4),ls_v2);
ls_value_clear(&ls_v2);
}
ls_value_copy(&(ls_v3),ls_c4);
ls_v4 = (ls_value){0};
ls_v5 = ls_value_equal(ls_v3,ls_v4);
if (ls_v5) {
ls_value_copy(&(ls_v6),ls_c2);
ls_value_copy(&(ls_v7),ls_c3);
ls_v8 = ls_value_equal(ls_v6,ls_v7);
if (ls_v8) {
ls_value_copy(&(ls_v9),ls_c2);
ls_value_copy(&(ls_v10),ls_v9);
{
ls_value ls_return = ls_v10;
ls_value_retain(ls_return);
ls_value_clear(&ls_v10);
ls_value_clear(&ls_v9);
ls_value_clear(&ls_v12);
ls_value_clear(&ls_v11);
ls_value_clear(&ls_v7);
ls_value_clear(&ls_v6);
ls_value_clear(&ls_v23);
ls_value_clear(&ls_v22);
ls_value_clear(&ls_v18);
ls_value_clear(&ls_v17);
ls_value_clear(&ls_v16);
ls_value_clear(&ls_v15);
ls_callable0_clear(&ls_v14);
ls_callable0_clear(&ls_c5);
ls_callable0_clear(&ls_v13);
ls_value_clear(&ls_v3);
ls_value_clear(&ls_v0);
ls_value_clear(&ls_c4);
ls_value_clear(&ls_c3);
ls_value_clear(&ls_c2);
return ls_return;
}
ls_value_clear(&ls_v10);
ls_value_clear(&ls_v9);
}
ls_value_copy(&(ls_v11),ls_c3);
ls_value_copy(&(ls_v12),ls_v11);
{
ls_value ls_return = ls_v12;
ls_value_retain(ls_return);
ls_value_clear(&ls_v12);
ls_value_clear(&ls_v11);
ls_value_clear(&ls_v7);
...
ls_callable0_copy(&(ls_v13),ls_value_to_callable0(ls_c4));
ls_callable0_copy(&(ls_c5),ls_v13);
ls_callable0_copy(&(ls_v14),ls_c5);
ls_value_copy(&(ls_v15),ls_c2);
ls_value_copy(&(ls_v16),ls_v15);
ls_value_copy(&(ls_v17),ls_c3);
ls_value_copy(&(ls_v18),ls_v17);
ls_v19 = ls_v14.code(ls_v14.environment,ls_v16,ls_v18);
if (ls_v19) {
ls_value_copy(&(ls_v20),ls_c2);
ls_value_copy(&(ls_v21),ls_v20);
{
ls_value ls_return = ls_v21;
ls_value_retain(ls_return);
ls_value_clear(&ls_v21);
ls_value_clear(&ls_v20);
ls_value_clear(&ls_v23);
ls_value_clear(&ls_v22);
ls_value_clear(&ls_v18);
ls_value_clear(&ls_v17);
...
ls_value_copy(&(ls_v22),ls_c3);
ls_value_copy(&(ls_v23),ls_v22);
{
ls_value ls_return = ls_v23;
ls_value_retain(ls_return);
ls_value_clear(&ls_v23);
ls_value_clear(&ls_v22);
ls_value_clear(&ls_v18);

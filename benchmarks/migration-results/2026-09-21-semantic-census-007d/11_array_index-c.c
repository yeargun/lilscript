...
ls_array0_copy(&(ls_v4),ls_c0);
ls_v5 = ls_from_u32(UINT32_C(1));
ls_array0_copy(&(ls_v6),ls_c0);
ls_v7 = ls_from_u32(UINT32_C(0));
ls_v8 = ls_array0_get(ls_v6,ls_v7);
ls_array0_copy(&(ls_v9),ls_c0);
ls_v10 = ls_from_u32(UINT32_C(2));
ls_v11 = ls_array0_get(ls_v9,ls_v10);
ls_v12 = ls_from_u32((uint32_t)((uint32_t)ls_v8 + (uint32_t)ls_v11));
ls_array0_set(ls_v4,ls_v5,ls_v12);
ls_array0_copy(&(ls_v13),ls_c0);
ls_v14 = ls_from_u32(UINT32_C(1));
ls_v15 = ls_array0_get(ls_v13,ls_v14);
printf("%ld\n",(long)ls_v15);
ls_array0_copy(&(ls_v17),ls_c0);
ls_v18 = (int32_t)ls_v17->length;
printf("%ld\n",(long)ls_v18);

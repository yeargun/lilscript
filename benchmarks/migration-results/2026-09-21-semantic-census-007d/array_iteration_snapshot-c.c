...
static inline bool ls_callable1_call(ls_callable1 value,int32_t ls_p0) {
ls_native_retain(value.environment);
...
typedef struct {
int32_t (*code)(void *,int32_t,int32_t);
void *environment;
uint64_t identity;
} ls_callable2;
...
static inline int32_t ls_callable2_call(ls_callable2 value,int32_t ls_p0,int32_t ls_p1) {
ls_native_retain(value.environment);
int32_t result = value.code(value.environment,ls_p0,ls_p1);
ls_native_release(value.environment);
return result;
}
typedef struct {
...
static inline void ls_callable3_call(ls_callable3 value,int32_t ls_p0) {
ls_native_retain(value.environment);
...
static ls_array0 * ls_c4 = NULL;
static bool ls_ready4;
static ls_array0 * *ls_g4(void) {
if (!ls_ready4) ls_native_unbound();
return &ls_c4;
}
static ls_array0 * ls_c6 = NULL;
static bool ls_ready6;
static ls_array0 * *ls_g6(void) {
if (!ls_ready6) ls_native_unbound();
return &ls_c6;
}
static ls_array0 * ls_c8 = NULL;
static bool ls_ready8;
static ls_array0 * *ls_g8(void) {
if (!ls_ready8) ls_native_unbound();
return &ls_c8;
}
static ls_array0 * ls_c10 = NULL;
static bool ls_ready10;
static ls_array0 * *ls_g10(void) {
if (!ls_ready10) ls_native_unbound();
return &ls_c10;
}
static int32_t ls_c11;
static bool ls_ready11;
static int32_t *ls_g11(void) {
if (!ls_ready11) ls_native_unbound();
return &ls_c11;
}
static void ls_init0(void);
static int32_t ls_fn1(int32_t ls_c12);
static bool ls_fn2(int32_t ls_c13);
static int32_t ls_fn3(int32_t ls_c14,int32_t ls_c15);
static void ls_fn4(int32_t ls_c16);
static int32_t ls_adapter1(void *environment,int32_t ls_p0) {
(void)environment;
return ls_fn1(ls_p0);
}
static bool ls_adapter2(void *environment,int32_t ls_p0) {
(void)environment;
return ls_fn2(ls_p0);
}
static int32_t ls_adapter3(void *environment,int32_t ls_p0,int32_t ls_p1) {
(void)environment;
return ls_fn3(ls_p0,ls_p1);
}
static void ls_adapter4(void *environment,int32_t ls_p0) {
(void)environment;
ls_fn4(ls_p0);
}
static void ls_init0(void) {
ls_array0 * ls_c5 = NULL;
ls_array0 * ls_c7 = NULL;
int32_t ls_c9;
int32_t ls_v4;
int32_t ls_v5;
ls_array0 * ls_v6 = NULL;
ls_array0 * ls_v7 = NULL;
ls_array0 * ls_v9 = NULL;
ls_array0 * ls_v10 = NULL;
int32_t ls_v11;
ls_array0 * ls_v13 = NULL;
int32_t ls_v14;
ls_array0 * ls_v16 = NULL;
int32_t ls_v17;
int32_t ls_v18;
int32_t ls_v20;
int32_t ls_v21;
...
ls_array0 * ls_v35 = NULL;
int32_t ls_v37;
int32_t ls_v38;
ls_array0 * ls_v39 = NULL;
int32_t ls_v40;
int32_t ls_v42;
int32_t ls_v44;
int32_t ls_v45;
ls_array0 * ls_v46 = NULL;
int32_t ls_v47;
ls_array0 * ls_v48 = NULL;
int32_t ls_v51;
ls_array0 * ls_v53 = NULL;
int32_t ls_v54;
ls_v4 = ls_from_u32(UINT32_C(1));
ls_v5 = ls_from_u32(UINT32_C(2));
ls_array0_take(&(ls_v6),ls_array0_new(2));
ls_array0_push(ls_v6,ls_v4);
ls_array0_push(ls_v6,ls_v5);
ls_array0_copy(&(ls_c4),ls_v6);
ls_ready4 = true;
ls_array0_copy(&(ls_v7),ls_c4);
{
ls_array0 *ls_src = ls_v7;
size_t ls_len = ls_src->length;
ls_array0 *ls_out = ls_array0_new(ls_len);
for (size_t ls_k = 0; ls_k < ls_len; ls_k++) {
if (ls_k >= ls_src->length) { ls_array0_hole(ls_out); continue; }
ls_array0_push_owned(ls_out,ls_fn1(ls_src->items[ls_k]));
}
ls_array0_take(&(ls_v9),ls_out);
}
ls_array0_copy(&(ls_c5),ls_v9);
ls_array0_copy(&(ls_v10),ls_c4);
ls_v11 = (int32_t)ls_v10->length;
printf("%ld\n",(long)ls_v11);
ls_array0_copy(&(ls_v13),ls_c5);
ls_v14 = (int32_t)ls_v13->length;
printf("%ld\n",(long)ls_v14);
ls_array0_copy(&(ls_v16),ls_c5);
ls_v17 = ls_from_u32(UINT32_C(1));
ls_v18 = ls_array0_get(ls_v16,ls_v17);
printf("%ld\n",(long)ls_v18);
ls_v20 = ls_from_u32(UINT32_C(1));
ls_v21 = ls_from_u32(UINT32_C(2));
ls_array0_take(&(ls_v22),ls_array0_new(2));
ls_array0_push(ls_v22,ls_v20);
ls_array0_push(ls_v22,ls_v21);
ls_array0_copy(&(ls_c6),ls_v22);
ls_ready6 = true;
ls_array0_copy(&(ls_v23),ls_c6);
{
ls_array0 *ls_src = ls_v23;
size_t ls_len = ls_src->length;
ls_array0 *ls_out = ls_array0_new(0);
for (size_t ls_k = 0; ls_k < ls_len; ls_k++) {
if (ls_k >= ls_src->length) continue;
int32_t ls_item = ls_src->items[ls_k];
if (ls_fn2(ls_item)) ls_array0_push(ls_out, ls_item);
}
ls_array0_take(&(ls_v25),ls_out);
}
ls_array0_copy(&(ls_c7),ls_v25);
ls_array0_copy(&(ls_v26),ls_c6);
ls_v27 = (int32_t)ls_v26->length;
printf("%ld\n",(long)ls_v27);
ls_array0_copy(&(ls_v29),ls_c7);
ls_v30 = (int32_t)ls_v29->length;
printf("%ld\n",(long)ls_v30);
ls_v32 = ls_from_u32(UINT32_C(1));
ls_v33 = ls_from_u32(UINT32_C(2));
ls_array0_take(&(ls_v34),ls_array0_new(2));
ls_array0_push(ls_v34,ls_v32);
ls_array0_push(ls_v34,ls_v33);
ls_array0_copy(&(ls_c8),ls_v34);
ls_ready8 = true;
ls_array0_copy(&(ls_v35),ls_c8);
ls_v37 = ls_from_u32(UINT32_C(0));
{
int32_t ls_acc = ls_v37;
{
ls_array0 *ls_src = ls_v35;
size_t ls_len = ls_src->length;
for (size_t ls_k = 0; ls_k < ls_len; ls_k++) {
if (ls_k >= ls_src->length) continue;
ls_acc = ls_fn3(ls_acc,ls_src->items[ls_k]);
}
}
ls_v38 = ls_acc;
}
ls_c9 = ls_v38;
ls_array0_copy(&(ls_v39),ls_c8);
ls_v40 = (int32_t)ls_v39->length;
printf("%ld\n",(long)ls_v40);
ls_v42 = ls_c9;
printf("%ld\n",(long)ls_v42);
ls_v44 = ls_from_u32(UINT32_C(1));
ls_v45 = ls_from_u32(UINT32_C(2));
ls_array0_take(&(ls_v46),ls_array0_new(2));
ls_array0_push(ls_v46,ls_v44);
ls_array0_push(ls_v46,ls_v45);
ls_array0_copy(&(ls_c10),ls_v46);
ls_ready10 = true;
ls_v47 = ls_from_u32(UINT32_C(0));
ls_c11 = ls_v47;
ls_ready11 = true;
ls_array0_copy(&(ls_v48),ls_c10);
{
ls_array0 *ls_src = ls_v48;
size_t ls_len = ls_src->length;
for (size_t ls_k = 0; ls_k < ls_len; ls_k++) {
if (ls_k >= ls_src->length) continue;
ls_fn4(ls_src->items[ls_k]);
}
}
ls_v51 = ls_c11;
printf("%ld\n",(long)ls_v51);
ls_array0_copy(&(ls_v53),ls_c10);
ls_v54 = (int32_t)ls_v53->length;
printf("%ld\n",(long)ls_v54);
ls_array0_clear(&ls_v53);
ls_array0_clear(&ls_v48);
ls_array0_clear(&ls_v46);
ls_array0_clear(&ls_v39);
ls_array0_clear(&ls_v35);
ls_array0_clear(&ls_v34);
ls_array0_clear(&ls_v29);
ls_array0_clear(&ls_v26);
ls_array0_clear(&ls_c7);
ls_array0_clear(&ls_v25);
ls_array0_clear(&ls_v23);
ls_array0_clear(&ls_v22);
ls_array0_clear(&ls_v16);
ls_array0_clear(&ls_v13);
ls_array0_clear(&ls_v10);
...
int32_t ls_v8;
int32_t ls_v9;
ls_array0_copy(&(ls_v0),(*ls_g4()));
ls_v1 = (int32_t)ls_v0->length;
ls_v2 = ls_from_u32(UINT32_C(2));
ls_v3 = ls_v1 == ls_v2;
if (ls_v3) {
ls_array0_copy(&(ls_v4),(*ls_g4()));
ls_v5 = ls_from_u32(UINT32_C(3));
ls_v6 = ls_array0_push(ls_v4,ls_v5);
ls_array0_clear(&ls_v4);
}
ls_v7 = ls_c12;
ls_v8 = ls_from_u32(UINT32_C(2));
ls_v9 = ls_mul(ls_v7,ls_v8);
{
int32_t ls_return = ls_v9;
...
int32_t ls_v8;
bool ls_v9;
ls_array0_copy(&(ls_v0),(*ls_g6()));
ls_v1 = (int32_t)ls_v0->length;
ls_v2 = ls_from_u32(UINT32_C(2));
ls_v3 = ls_v1 == ls_v2;
if (ls_v3) {
ls_array0_copy(&(ls_v4),(*ls_g6()));
ls_v5 = ls_from_u32(UINT32_C(3));
ls_v6 = ls_array0_push(ls_v4,ls_v5);
ls_array0_clear(&ls_v4);
}
ls_v7 = ls_c13;
ls_v8 = ls_from_u32(UINT32_C(0));
ls_v9 = ls_v7 > ls_v8;
{
bool ls_return = ls_v9;
ls_array0_clear(&ls_v0);
return ls_return;
}
ls_array0_clear(&ls_v0);
...
int32_t ls_v8;
int32_t ls_v9;
ls_array0_copy(&(ls_v0),(*ls_g8()));
ls_v1 = (int32_t)ls_v0->length;
ls_v2 = ls_from_u32(UINT32_C(2));
ls_v3 = ls_v1 == ls_v2;
if (ls_v3) {
ls_array0_copy(&(ls_v4),(*ls_g8()));
ls_v5 = ls_from_u32(UINT32_C(3));
ls_v6 = ls_array0_push(ls_v4,ls_v5);
ls_array0_clear(&ls_v4);
}
...
(*ls_g11()) = ls_v2;
ls_array0_copy(&(ls_v3),(*ls_g10()));
ls_v4 = (int32_t)ls_v3->length;
ls_v5 = ls_from_u32(UINT32_C(2));
ls_v6 = ls_v4 == ls_v5;
if (ls_v6) {
ls_array0_copy(&(ls_v7),(*ls_g10()));
ls_v8 = ls_c16;
ls_v9 = ls_from_u32(UINT32_C(2));
ls_v10 = ls_from_u32((uint32_t)((uint32_t)ls_v8 + (uint32_t)ls_v9));
ls_v11 = ls_array0_push(ls_v7,ls_v10);
ls_array0_clear(&ls_v7);
}
...
ls_init0();
ls_array0_clear(&ls_c4);
ls_array0_clear(&ls_c6);
ls_array0_clear(&ls_c8);

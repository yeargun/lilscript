...
ls_array0_take(&(ls_v2),ls_array0_new(2));
ls_array0_push(ls_v2,ls_v0);
ls_array0_push(ls_v2,ls_v1);
ls_array0_copy(&(ls_c0),ls_v2);
ls_array0_copy(&(ls_v3),ls_c0);
ls_v4 = ls_from_u32(UINT32_C(8));
ls_v5 = ls_array0_push(ls_v3,ls_v4);
ls_c1 = ls_v5;
ls_array0_copy(&(ls_v6),ls_c0);
ls_v7 = ls_array0_pop(ls_v6);
ls_c2 = ls_v7;
ls_v8 = ls_c1;
printf("%ld\n",(long)ls_v8);
ls_v10 = ls_c2;

...
static const uint16_t ls_s3[] = {116,104,101,109,101,45,114,101,97,100,};
static const uint16_t ls_s4[] = {100,97,114,107,};
static const uint16_t ls_s5[] = {100,97,114,107,45,117,105,};
static const uint16_t ls_s6[] = {108,105,103,104,116,45,117,105,};
static const uint16_t ls_s7[] = {58,99,111,109,112,97,99,116,};
static const uint16_t ls_s8[] = {58,99,111,109,102,111,114,116,97,98,108,101,};
static void ls_init0(void);
static ls_string ls_fn1(void);
static ls_string ls_fn2(ls_string ls_c4);
static ls_string ls_fn3(ls_t0 ls_c5);
static void ls_init0(void) {
ls_t0 ls_c3;
ls_string ls_v3;
bool ls_v4;
...
ls_t0 ls_v14;
ls_string ls_v15;
ls_v3 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v4 = true;
ls_v5 = (ls_t0){ls_v3,ls_v4};
ls_v6 = ls_v5;
ls_c3 = ls_v6;
ls_v9 = ls_fn1();
ls_v10 = ls_fn2(ls_v9);
ls_print_string(ls_v10);
ls_v13 = ls_c3;
ls_v14 = ls_v13;
ls_v15 = ls_fn3(ls_v14);
ls_print_string(ls_v15);
}
static ls_string ls_fn1(void) {
ls_string ls_v0;
ls_string ls_v2;
ls_v0 = (ls_string){ls_s3,sizeof ls_s3/sizeof *ls_s3};
ls_print_string(ls_v0);
ls_v2 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
return ls_v2;
}
static ls_string ls_fn2(ls_string ls_c4) {
ls_string ls_v0;
...
ls_string ls_v4;
ls_v0 = ls_c4;
ls_v1 = (ls_string){ls_s4,sizeof ls_s4/sizeof *ls_s4};
ls_v2 = ls_string_equal(ls_v0,ls_v1);
if (ls_v2) {
ls_v3 = (ls_string){ls_s5,sizeof ls_s5/sizeof *ls_s5};
return ls_v3;
}
ls_v4 = (ls_string){ls_s6,sizeof ls_s6/sizeof *ls_s6};
return ls_v4;
}
static ls_string ls_fn3(ls_t0 ls_c5) {
bool ls_v0;
...
if (ls_v0) {
ls_v1 = ls_c5.ls_f0;
ls_v2 = (ls_string){ls_s7,sizeof ls_s7/sizeof *ls_s7};
ls_v3 = ls_string_concat(ls_v1,ls_v2);
return ls_v3;
}
ls_v4 = ls_c5.ls_f0;
ls_v5 = (ls_string){ls_s8,sizeof ls_s8/sizeof *ls_s8};
ls_v6 = ls_string_concat(ls_v4,ls_v5);
return ls_v6;
}
int main(void) {

...
ls_v3 = ls_mul(ls_v1,ls_v2);
ls_v4 = ls_from_u32((uint32_t)((uint32_t)ls_v0 + (uint32_t)ls_v3));
printf("%ld\n",(long)ls_v4);
ls_v6 = ls_from_u32(UINT32_C(2147483647));
ls_v7 = ls_from_u32(UINT32_C(1));
ls_v8 = ls_from_u32((uint32_t)((uint32_t)ls_v6 + (uint32_t)ls_v7));
printf("%ld\n",(long)ls_v8);
ls_v10 = ls_from_u32(UINT32_C(10));
ls_v11 = ls_from_u32(UINT32_C(4));
ls_v12 = ls_from_u32((uint32_t)((uint32_t)ls_v10 - (uint32_t)ls_v11));
ls_v13 = ls_from_u32(UINT32_C(3));
ls_v14 = ls_div(ls_v12,ls_v13);
printf("%ld\n",(long)ls_v14);
}
int main(void) {

...
function p(e, t, n) {
	e[0] = t, e[1] = n, e[2] = [], e[3] = [], Me(() => {
		for (var t = a(e[0]), n = e[1], r = 0, i; r < e[2].length; r += 1) i = e[3][r], o(i, n(e[2][r], t));
	});
}
function m(e, t) {
	for (var r = e[1], i = 0; i < e[2].length; i += 1) if (r(e[2][i], t)) return a(e[3][i]);
...
function _(e, t, r) {
	...
	for (d = [], f = [], p = [], m = [], c = 0; c < t.length; c += 1) {
		...
		a >= 0 ? (i.add(a), o(e[3][a], c), f.push(e[1][a]), p.push(e[2][a]), m.push(e[3][a])) : (g = [
			...
			0,
			0
		], n(g, c, ae), _ = [null], _[0] = () => {}, f.push(E(((e, t, n, r) => (i) => (r[0] = i, e(t, n)))(r, h, g, _), null, !1)), p.push(_), m.push(g)), d.push(h);
	}
...
function b(e, t, r) {
	...
	for (var l = e[2].length; l < t.length; l = l + 1 | 0) a = t[l], s = [
		...
		0,
		0
	], n(s, a, (e, t) => e == t), c = [null], c[0] = () => {}, a = E(((e, t, n) => (r) => (n[0] = r, e(t, l)))(r, s, c), null, !1), e[2].push(s), e[1].push(c), e[0].push(a);
...
var ae = (e, t) => e == t, oe = (e, t) => e == t, se = (e) => {
	...
	for (var t = 0; t < z.length; t += 1) if ((z[t] | 0) == e) return ce(t), !0;
	return !1;
}, ue = (e, t) => {
	...
	if (e == 1) {
		...
		return n || (n = [
			...
			0,
			null
		], n[0] = e, n[1] = t, n[2] = null, j[t][6] = n, n[2] = C(j[t][1], j[t][2]), n);
	}
	return e == 2 ? (n = A[t][8]) ? n : (n = [
		0,
		0,
		null
	], n[0] = e, n[1] = t, n[2] = null, A[t][8] = n, n[2] = C(A[t][1], A[t][2]), n) : null;
}, de = (e) => {
	...
	for (var r = 0; r < A[e][13].length; r += 1) if (pe(A[e][13][r] | 0, t, n + 1 | 0)) return !0;
	return !1;
}, me = (e) => {
	if (N >= 0 && A[N][9] && !R && pe(N, e) && !ge(e, N)) throw "Reactive dependency cycle detected.";
	!A[e][11] && !se(e) && z.push(e);
}, he = (e) => {
	for (var t = 0; t < A[e][13].length; t += 1) if (se(A[e][13][t] | 0)) return !0;
	return !1;
}, ge = (e, t) => {
	var n = A[t][1];
	t = A[t][2];
	...
	var t, n;
	if (!(A[e][11] || e == N)) {
		for (n = 0; n < A[e][13].length; n += 1) t = A[e][13][n] | 0, (se(t) || he(t)) && _e(t);
		le(e) && f(A[e]);
	}
}, ve = () => {
	for (var e = -1, t = -1, n = -1, r = 0, i, a, o, s, c; r < z.length; r += 1) i = z[r] | 0, A[i][9] ? (e < 0 || A[i][12] > A[z[e] | 0][12]) && (e = r) : !A[i][10] && t < 0 ? t = r : n < 0 ? n = r : (o = z[n] | 0, a = A[i], s = A[o], c = a[1] == s[1] && a[2] == s[2], (c && a[12] > s[12] || !c && (ge(i, o) || !ge(o, i) && a[12] > s[12])) && (n = r));
	return t >= 0 && (e = t), e >= 0 && (n = e), ce(n);
}, w = () => {
	if (!(L || F > 0 || I > 0)) {
		L = !0;
		var t = 0;
	...
	for (n[0] = $e, n[1] = e, n[2] = t, n[3] = !1, $e = $e + 1 | 0, B.push(n), e = B.length - 1; t = e > 0 && B[e][2] < B[e - 1][2], t;) {
		t = e - 1;
		var r = B[t];
		B[t] = B[e], B[e] = r, e = t;
	}
	...
	var t = [null];
	return t[0] = e, N >= 0 ? A[N][7].push(t) : P >= 0 && j[P][5].push(t), e;
}, k = (e) => {
	var t = M;
	M = -1;
	try {

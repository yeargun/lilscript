...
var d = (e) => {
	for (var t = 0; t < M.length; t += 1) if ((M[t] | 0) == e) return !0;
	return !1;
}, f = (e) => {
	for (var t = M[e] | 0; e < M.length - 1; e = e + 1 | 0) M[e] = M[e + 1 | 0] | 0;
	return M.pop(), t;
}, p = (e) => {
	for (var t = 0; t < M.length; t += 1) if ((M[t] | 0) == e) return f(t), !0;
	return !1;
}, m = (e, t) => {
	...
	for (var r = 0; r < C[e][13].length; r += 1) if (h(C[e][13][r] | 0, t, n + 1 | 0)) return !0;
	return !1;
}, ne = (e) => {
	if (E >= 0 && C[E][9] && !j && h(E, e) && !g(e, E)) throw "Reactive dependency cycle detected.";
	!C[e][11] && !d(e) && M.push(e);
}, re = (e) => {
	for (var t = 0; t < C[e][13].length; t += 1) if (d(C[e][13][t] | 0)) return !0;
	return !1;
}, g = (e, t) => {
	var n = C[t][1];
	t = C[t][2];
	...
	var t, n;
	if (!(C[e][11] || e == E)) {
		for (n = 0; n < C[e][13].length; n += 1) t = C[e][13][n] | 0, (d(t) || re(t)) && _(t);
		p(e) && u(C[e]);
	}
}, ie = () => {
	for (var e = -1, t = -1, n = -1, r = 0, i, a, o, s, c; r < M.length; r += 1) i = M[r] | 0, C[i][9] ? (e < 0 || C[i][12] > C[M[e] | 0][12]) && (e = r) : !C[i][10] && t < 0 ? t = r : n < 0 ? n = r : (o = M[n] | 0, a = C[i], s = C[o], c = a[1] == s[1] && a[2] == s[2], (c && a[12] > s[12] || !c && (g(i, o) || !g(o, i) && a[12] > s[12])) && (n = r));
	return t >= 0 && (e = t), e >= 0 && (n = e), f(n);
}, v = () => {
	if (!(A || O > 0 || k > 0)) {
		A = !0;
		var t = 0;

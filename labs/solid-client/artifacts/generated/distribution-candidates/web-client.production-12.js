...
function h(e, t, r) {
	...
	for (d = [], f = [], p = [], m = [], c = 0; c < t.length; c++) {
		...
		a >= 0 ? (i.add(a), o(e[3][a], c), f.push(e[1][a]), p.push(e[2][a]), m.push(e[3][a])) : (g = [
			...
			0,
			0
		], n(g, c, re), _ = [() => {}], f.push(S(((e, t, n, r) => (i) => (r[0] = i, e(t, n)))(r, h, g, _), null, !1)), p.push(_), m.push(g)), d.push(h);
	}
...
function ee(e, t, r) {
	...
	for (var l = e[2].length; l < t.length; l = l + 1 | 0) a = t[l], s = [
		...
		0,
		0
	], n(s, a, (e, t) => e == t), c = [() => {}], a = S(((e, t, n) => (r) => (n[0] = r, e(t, l)))(r, s, c), null, !1), e[2].push(s), e[1].push(c), e[0].push(a);
...
var re = (e, t) => e == t, ie = (e) => {
	for (var t = 0; t < F.length; t++) if ((F[t] | 0) == e) return !0;
	return !1;
}, ae = (e) => {
	for (var t = F[e] | 0; e < F.length - 1; e = e + 1 | 0) F[e] = F[e + 1 | 0] | 0;
	return F.pop(), t;
}, oe = (e) => {
	for (var t = 0; t < F.length; t++) if ((F[t] | 0) == e) return ae(t), !0;
	return !1;
}, y = (e, t) => {
	...
	if (e == 1) {
		...
		return n || (n = [
			...
			t,
			null
		], D[t][6] = n, n[2] = b(D[t][1], D[t][2]), n);
	}
	return e == 2 ? (n = E[t][8]) ? n : (n = [
		e,
		t,
		null
	], E[t][8] = n, n[2] = b(E[t][1], E[t][2]), n) : null;
}, se = (e) => {
	...
	for (var r = 0; r < E[e][13].length; r++) if (le(E[e][13][r] | 0, t, n + 1 | 0)) return !0;
	return !1;
}, ue = (e) => {
	if (k >= 0 && E[k][9] && !P && le(k, e) && !fe(e, k)) throw "Reactive dependency cycle detected.";
	!E[e][11] && !ie(e) && F.push(e);
}, de = (e) => {
	for (var t = 0; t < E[e][13].length; t++) if (ie(E[e][13][t] | 0)) return !0;
	return !1;
}, fe = (e, t) => {
	var n = E[t][1];
	t = E[t][2];
	...
	var t, n;
	if (!(E[e][11] || e == k)) {
		for (n = 0; n < E[e][13].length; n++) t = E[e][13][n] | 0, (ie(t) || de(t)) && pe(t);
		oe(e) && f(E[e]);
	}
}, me = () => {
	for (var e = -1, t = -1, n = -1, r = 0, i, a, o, s, c; r < F.length; r++) i = F[r] | 0, E[i][9] ? (e < 0 || E[i][12] > E[F[e] | 0][12]) && (e = r) : !E[i][10] && t < 0 ? t = r : n < 0 ? n = r : (o = F[n] | 0, a = E[i], s = E[o], c = a[1] == s[1] && a[2] == s[2], (c && a[12] > s[12] || !c && (fe(i, o) || !fe(o, i) && a[12] > s[12])) && (n = r));
	return t >= 0 && (e = t), ae(e < 0 ? n : e);
}, he = () => {
	if (!(N || j > 0 || M > 0)) {
		N = !0;
		var t = 0;
	...
	var t = [e];
	return k >= 0 ? E[k][7].push(t) : A >= 0 && D[A][5].push(t), e;
}, T = (e) => {
	var t = O;
	O = -1;
	try {

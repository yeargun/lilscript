...
var re = (e, t) => e == t, ie = (e) => {
	...
	if (e == 1) {
		...
		return n || (n = [
			...
			t,
			null
		], D[t][6] = n, n[2] = y(D[t][1], D[t][2]), n);
	}
	return e == 2 ? (n = E[t][8]) ? n : (n = [
		e,
		t,
		null
	], E[t][8] = n, n[2] = y(E[t][1], E[t][2]), n) : null;
}, ce = (e) => {
	...
	for (var r = 0; r < E[e][13].length; r++) if (ue(E[e][13][r] | 0, t, n + 1 | 0)) return !0;
	return !1;
}, de = (e) => {
	...
	var t, n;
	if (!(E[e][11] || e == k)) {
		for (n = 0; n < E[e][13].length; n++) t = E[e][13][n] | 0, (ie(t) || fe(t)) && me(t);
		oe(e) && f(E[e]);
	}
}, he = () => {
	for (var e = -1, t = -1, n = -1, r = 0, i, a, o, s, c; r < F.length; r++) i = F[r] | 0, E[i][9] ? (e < 0 || E[i][12] > E[F[e] | 0][12]) && (e = r) : !E[i][10] && t < 0 ? t = r : n < 0 ? n = r : (o = F[n] | 0, a = E[i], s = E[o], c = a[1] == s[1] && a[2] == s[2], (c && a[12] > s[12] || !c && (pe(i, o) || !pe(o, i) && a[12] > s[12])) && (n = r));

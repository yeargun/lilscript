# Migration history — the narrative ledger, as written

Parent: [index](index.md). **The dense, authoritative state is [progress.md](progress.md)**; this
file is the long-form record every row there compresses, kept as written because a plan that
quietly edits its own premises cannot be checked against what happened. From 2026-09-05 on, a step
adds one row to `progress.md` and, when it has a story worth the space, one paragraph here.

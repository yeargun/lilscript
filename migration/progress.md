...
| live-15 | jquerylil: "startup limits rejected every JavaScript candidate" on the pool with `8e17fc3`, `5a0e0e4` and the 7a arms alike; the branch's earlier pins are being bisected (`acace54`, `b2a789e`, `06edd9b`) | 7.10 fleet A/B | **open**; pre-dates 7.9 |

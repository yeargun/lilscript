...
impl<'program, 'src> DemandPlan<'program, 'src> {
    pub(in crate::program) fn product_lookup_work(&self) -> usize {
    ...
    pub(in crate::program) fn products(&self) -> &[&'program ProductFamily] {
        &self.products
    }
    pub(in crate::program) fn product_for_cell(&self, cell: CellId) -> Option<usize> {
    ...
    pub(in crate::program) fn product_for_value(
        &self,
        unit: UnitId,
        value: ValueId,
    ) -> Option<usize> {
    ...
    pub(in crate::program) fn product_operation(
        &self,
        unit: UnitId,
        operation: OpId,
    ...
    pub(in crate::program) fn product_cells(
        &self,
        context: ContextId,
    ...
    pub(in crate::program) fn product_snapshots(
        &self,
        context: ContextId,
    ...
    pub(in crate::program) fn needs_product_slot(
        &self,
        context: ContextId,
        cell: CellId,
        slot: u32,
    ...
    pub(in crate::program) fn stable_product_slot_visited<E>(
        &self,
        context: ContextId,
        cell: CellId,
        slot: u32,
    ...
    pub(in crate::program) fn needs_snapshot_slot(
        &self,
        context: ContextId,
        value: ValueId,
        slot: u32,

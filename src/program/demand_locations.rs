...
pub(in crate::program) enum LocationDemand {
    #[default]
    None,
...
pub(in crate::program) struct PlaceLocation {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::program) struct ResolvedLocation {
    pub context: ContextId,
    pub cell: CellId,
...
pub(in crate::program) enum LocationCheck {
...
impl<'program, 'src> DemandPlan<'program, 'src> {
    ...
    pub(in crate::program) fn resolve_location_visited<E>(
        &self,
    ...
    pub(in crate::program) fn location_check_proved_visited<E>(
        &self,
    ...
    pub(in crate::program) fn writes_incoming_references_visited<E>(
        &self,
        mut visit: impl FnMut(usize) -> Result<(), E>,
    ) -> Result<bool, E> {
        visit(1)?;
    ...
    pub(in crate::program) fn cell_location_visited<E>(
        &self,
        context: ContextId,
        cell: CellId,
        mut visit: impl FnMut(usize) -> Result<(), E>,
    ...
    pub(in crate::program) fn product_location_visited<E>(
        &self,
        context: ContextId,
        cell: CellId,
        mut visit: impl FnMut(usize) -> Result<(), E>,
    ...
    pub(in crate::program) fn has_shared_product_locations_visited<E>(
        &self,
        mut visit: impl FnMut(usize) -> Result<(), E>,
    ) -> Result<bool, E> {
        if self.products.is_empty() {

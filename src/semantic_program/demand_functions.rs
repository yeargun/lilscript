...
pub(in crate::semantic_program) enum SharedTransportSupport {
    MayApply,
    AllCreatorsInline,
}
...
pub(in crate::semantic_program) struct InlineActual<'program> {
...
impl<'program, 'src> DemandPlan<'program, 'src> {
    ...
    pub(in crate::semantic_program) fn effective_input_depth(
        &self,
        context: ContextId,
    ...
    pub(in crate::semantic_program) fn function_lookup_work(&self) -> usize {
        [
            self.functions.len(),
    ...
    pub(in crate::semantic_program) fn function_layout(
        &self,
        body: UnitId,
    ...
    pub(in crate::semantic_program) fn call_product_parameter(
        &self,
        context: ContextId,
        call: CallId,
        position: u32,
    ...
    pub(in crate::semantic_program) fn call_transport(
        &self,
        context: ContextId,
        call: CallId,
        position: u32,
    ...
    pub(in crate::semantic_program) fn call_has_empty_transport(
        &self,
        context: ContextId,
        call: CallId,
    ) -> bool {
    ...
    pub(in crate::semantic_program) fn inline_actual(
        &self,
        context: ContextId,
        position: u32,
    ...
    pub(in crate::semantic_program) fn inline_parameter_source(
        &self,
        context: ContextId,
        position: u32,
    ) -> (ContextId, ValueId) {

//! A direct, admitted C11 executable client of the checked semantic program.
...
mod binary;
pub(in crate::semantic_program) use binary::RUNTIME as BINARY_RUNTIME;
pub(in crate::semantic_program) use collections::RUNTIME as COLLECTIONS_RUNTIME;
pub(in crate::semantic_program) use dynamic::RUNTIME as DYNAMIC_RUNTIME;
...
/// use lilscript::semantic_program::publication::{Compilation, SemanticId};
///

...
use super::*;
use crate::semantic_program::native::{NativeArtifacts, NativeError};
use crate::semantic_program::rewrite_lineage::{RewriteDescription, RewriteLineage};
...
impl ArtifactArena {
    pub(in crate::semantic_program) fn retain_native(
        &mut self,
        files: NativeArtifacts,
        snapshot: RevisionId,
        meaning: RevisionId,
    ...
    pub(in crate::semantic_program) fn with_qualified_native<R>(
        &self,
        receipt: &QualifiedNativeArtifact,
    ...
    pub(in crate::semantic_program) fn take_qualified_native(
        &mut self,
        receipt: QualifiedNativeArtifact,
        budget: &mut AllocationBudget<'_>,

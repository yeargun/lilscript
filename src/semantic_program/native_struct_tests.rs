...
//! UBSan through the existing harness; this does not use the legacy backend.
    ...
    checked(source_text, |program| {
        ...
        eprintln!(
            ...
            serde_json::json!({
                ...
                "qualification":"semantic values and places; fixed trace; two qualified C compilers and Node; no legacy backend"
            })
        );
...
fn native_place_check_rejects_uninitialized_root_before_rhs_without_leaking() {
    checked(
        ...
        |mut program| {
            ...
            // The semantic program may express a runtime TDZ failure. This

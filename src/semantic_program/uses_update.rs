...
#[derive(Debug)]
pub(in crate::semantic_program) struct PreparedUseUpdate {
    owner: RevisionId,
...
impl PreparedUseUpdate {
    pub(in crate::semantic_program) fn receipt(&self) -> UseIndexReceipt {
        self.receipt
    }
    pub(in crate::semantic_program) fn validation_work(&self) -> usize {
        1
    }
    pub(in crate::semantic_program) fn valid_for(&self, destination: &UseIndex) -> bool {
        self.owner == destination.update_owner
    }
    pub(in crate::semantic_program) fn cell_changes(
        &self,
...
impl UseIndex {
    ...
    pub(in crate::semantic_program) fn validate_fixed_changes(
        &self,
        program: &Program<'_>,
    ...
    pub(in crate::semantic_program) fn prepare_fixed_replacements(
        &self,
    ...
    pub(in crate::semantic_program) fn prepare_replacements(
        &self,
        program: &Program<'_>,
        changed: &[UnitId],
        ledger: &mut BudgetLedger,
    ...
    pub(in crate::semantic_program) fn install_replacements(
        &mut self,
    ...
    pub(in crate::semantic_program) fn fork_fixed_replacements(
        &self,
        edits: &publication::FixedUnitEdits<'_, '_>,
        update: PreparedUseUpdate,
        ledger: &mut BudgetLedger,
    ...
    pub(in crate::semantic_program) fn fork_replacements(
        &self,
        program: &Program<'_>,
        update: PreparedUseUpdate,
        ledger: &mut BudgetLedger,

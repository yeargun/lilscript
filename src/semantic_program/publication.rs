...
pub enum CandidateError {
    ...
    Output(crate::structured_js::extract::OutputError),
    Artifact(&'static str),
    Codec(&'static str),
...
impl From<crate::structured_js::extract::OutputError> for CandidateError {
    fn from(error: crate::structured_js::extract::OutputError) -> Self {
        match error {
            crate::structured_js::extract::OutputError::Admission(error) => error.into(),
...
/// use lilscript::semantic_program::{UnitId, publication::{
...
/// ```compile_fail,E0499
/// use lilscript::compilation_policy::WorkDomain;
/// use lilscript::semantic_program::{UnitId, ValueId, publication::{
///     Compilation, LocalFactsRequest, SemanticId,
/// }};
///

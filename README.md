...
- **posthog-js kernel** — UUID, flags, cookies, routing, rate limits, queue, bot detection, and portable helpers from `posthog-js@1.418.10`, not the published IIFE. **5,622 → 5,793** Brotli vs Vite 8 Oxc of that same kernel (**+3.0%**). Live: [yeargun.github.io/posthoglil](https://yeargun.github.io/posthoglil/)

...
| [018](018-mobx-admission-regression/README.md) | mobxlil is +3577 with a frozen source — is that a compiler regression too? | **Yes: `src/compiler.rs` across `42c1ad0..edbdf3a`, +7940 raw / +920 Brotli.** Four mechanisms falsified — nothing rejects anything. 59s repro |

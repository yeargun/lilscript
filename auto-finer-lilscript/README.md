...
| [035](035-where-the-compiler-headroom-is/README.md) | What is left for the compiler, measured? | **Not the printer** — a pure reprint of our output saves 0 bytes. It is **name allocation**: on micromark we use 41 of 54 one-char names and our 60 most-frequent identifiers average 3.15 chars against Terser's 2.90. Terser extracts **−884 / −856 / −1136** from finished micromark / mobx / jquery artifacts. `local_name_reserve` swept and already optimal |

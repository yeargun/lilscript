...
const sizes=s=>{const b=Buffer.from(s);const c=canonicalCodecSizes(b,'motion size root cause');return {raw:c.raw,gzip9:c.gzip,brotli11:c.brotli,sha256:createHash('sha256').update(b).digest('hex')}};

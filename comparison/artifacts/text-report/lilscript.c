...
int main(void){const char* v16;const char* v18;uint32_t s=0;for(;;)switch(s){case 0:{s=1;continue;}case 1:{s=2;continue;}case 2:{v16="lilscript:true:true";puts(v16);v18="repeated-long-application-label";puts(v18);puts(v18);puts(v18);return 0;}}return 0;}
